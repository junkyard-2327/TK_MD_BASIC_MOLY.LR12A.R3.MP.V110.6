...
// for rake assembly use only
#if !(defined(__CR4__) || defined(__MIPS_IA__) || defined(__CORE_USIP__)) && defined(__RAKE__) && (defined(__darts__) || defined(__GNUC__))
#define MD32_IS_ASSEMBLY 1
#else
#define MD32_IS_ASSEMBLY 0
#endif
    ...
    #define INCLUDE_DSP_HEADER_ENABLE
        ...
        //#include "mt6295/xxif_checksum.h"
            ...
            #include "mt6295/CMIF/rake/CMIF_ALL.h"
        #elif defined(__CORE_RAKE__)
            #include "mt6295/CMIF/rake/CMIF_ALL.h"
        #else
            #error "CMIF should be used only by L1/uSIP or RAKE !!!"
        #endif
	#else
        //#include "mt6295/xxif_checksum.h"
        #if defined(__CR4__) || defined(__MIPS_IA__) || defined(__CORE_USIP__)
            #include "mt6295/CMIF/rake/CMIF_ALL_ASM.h"
        #elif defined(__CORE_RAKE__)
            #include "mt6295/CMIF/rake/CMIF_ALL_ASM.h"
        #else
            #error "CMIF should be used only by L1/uSIP or RAKE !!!"
    ...
    #define INCLUDE_DSP_HEADER_ENABLE
        ...
        #if defined(__CR4__) || defined(__MIPS_IA__) || defined(__CORE_USIP__)
            #include "mt6293/CMIF/rake/CMIF_ALL.h"
        #elif defined(__CORE_RAKE__)
            #include "mt6293/CMIF/rake/CMIF_ALL.h"
        #else
            #error "CMIF should be used only by L1/uSIP or RAKE !!!"
        ...
        //#include "mt6293/xxif_checksum.h"
        #if defined(__CR4__) || defined(__MIPS_IA__) || defined(__CORE_USIP__)
            #include "mt6293/CMIF/rake/CMIF_ALL_ASM.h"
        #elif defined(__CORE_RAKE__)
            #include "mt6293/CMIF/rake/CMIF_ALL_ASM.h"
        #else
            #error "CMIF should be used only by L1/uSIP or RAKE !!!"
...
#endif // __DSP_HEADER_DEFINE_CMIF_H__
