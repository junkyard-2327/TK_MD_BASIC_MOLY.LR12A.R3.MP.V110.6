...
#define CMIF_C2K_RECFG_EVENT_RA_CFG_CHANGE_BIT_LSB                    (24)
#define CMIF_C2K_RECFG_EVENT_RA_CFG_CHANGE_BIT_WIDTH                  (6)
#define CMIF_C2K_RECFG_EVENT_RA_CFG_CHANGE_BIT_MASK                   ((UINT32) (((1<<CMIF_C2K_RECFG_EVENT_RA_CFG_CHANGE_BIT_WIDTH)-1) << CMIF_C2K_RECFG_EVENT_RA_CFG_CHANGE_BIT_LSB) )
#define CMIF_C2K_RECFG_EVENT_RA_CFG_CHANGE_FLD_WR(reg, val)           (reg |= (val) << CMIF_C2K_RECFG_EVENT_RA_CFG_CHANGE_BIT_LSB)
#define CMIF_C2K_RECFG_EVENT_RA_CFG_CHANGE_FLD_RD()                   ((M_CMIF_C2K_RECFG_EVENT_RD() & CMIF_C2K_RECFG_EVENT_RA_CFG_CHANGE_BIT_MASK) >> CMIF_C2K_RECFG_EVENT_RA_CFG_CHANGE_BIT_LSB)

#define CMIF_C2K_RECFG_EVENT_MAC_CFG_CHANGE_BIT_LSB                   (18)
#define CMIF_C2K_RECFG_EVENT_MAC_CFG_CHANGE_BIT_WIDTH                 (6)
#define CMIF_C2K_RECFG_EVENT_MAC_CFG_CHANGE_BIT_MASK                  ((UINT32) (((1<<CMIF_C2K_RECFG_EVENT_MAC_CFG_CHANGE_BIT_WIDTH)-1) << CMIF_C2K_RECFG_EVENT_MAC_CFG_CHANGE_BIT_LSB) )
#define CMIF_C2K_RECFG_EVENT_MAC_CFG_CHANGE_FLD_WR(reg, val)          (reg |= (val) << CMIF_C2K_RECFG_EVENT_MAC_CFG_CHANGE_BIT_LSB)
#define CMIF_C2K_RECFG_EVENT_MAC_CFG_CHANGE_FLD_RD()                  ((M_CMIF_C2K_RECFG_EVENT_RD() & CMIF_C2K_RECFG_EVENT_MAC_CFG_CHANGE_BIT_MASK) >> CMIF_C2K_RECFG_EVENT_MAC_CFG_CHANGE_BIT_LSB)

#define CMIF_C2K_RECFG_EVENT_PMB_CFG_CHANGE_BIT_LSB                   (13)
#define CMIF_C2K_RECFG_EVENT_PMB_CFG_CHANGE_BIT_WIDTH                 (1)
#define CMIF_C2K_RECFG_EVENT_PMB_CFG_CHANGE_BIT_MASK                  ((UINT32) (((1<<CMIF_C2K_RECFG_EVENT_PMB_CFG_CHANGE_BIT_WIDTH)-1) << CMIF_C2K_RECFG_EVENT_PMB_CFG_CHANGE_BIT_LSB) )
#define CMIF_C2K_RECFG_EVENT_PMB_CFG_CHANGE_FLD_WR(reg, val)          (reg |= (val) << CMIF_C2K_RECFG_EVENT_PMB_CFG_CHANGE_BIT_LSB)
#define CMIF_C2K_RECFG_EVENT_PMB_CFG_CHANGE_FLD_RD()                  ((M_CMIF_C2K_RECFG_EVENT_RD() & CMIF_C2K_RECFG_EVENT_PMB_CFG_CHANGE_BIT_MASK) >> CMIF_C2K_RECFG_EVENT_PMB_CFG_CHANGE_BIT_LSB)
