...
my $smart_new_target= $ARGV[7]; # smart new target file
...
#****************************************************************************
# smart new print dependency file
#****************************************************************************
PrintDependModule();
PrintDependModule("$dsp_bin_file");
PrintDependModule("$project_mk");
PrintToDep("$smart_new_target");
