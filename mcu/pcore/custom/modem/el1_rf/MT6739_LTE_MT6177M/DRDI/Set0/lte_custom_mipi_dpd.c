...
{
   {
      ...
      MIPI_USID_PA0_Set0, /*USID*/
      {
         ...
         // PA_SEC_DATA0, PA_SEC_DATA1, PA_SEC_DATA2, PA_SEC_DATA3, PA_SEC_DATA4
         // {addr, data}, {addr, data}, {addr, data}, {addr, data}, {addr, data}
         {{ { 0x0 , 0x48}, { 0x1 , 0x07}  ,{ 0x0, 0x0 }  ,  { 0x0 , 0x0} , { 0x0 , 0x0}}},
...
{
   {
      ...
      MIPI_USID_PA0_Set0, /*USID*/
      {
         ...
         // PA_SEC_DATA0, PA_SEC_DATA1, PA_SEC_DATA2, PA_SEC_DATA3, PA_SEC_DATA4
         // {addr, data}, {addr, data}, {addr, data}, {addr, data}, {addr, data}
         {{ { 0x0, 0x40}, { 0x1, 0x07},{ 0x0, 0x0},  { 0x0, 0x0 }, { 0x0, 0x0 }}},
...
const LTE_MIPI_TPC_SECTION_TABLE_T LTE_Band6_MIPI_DPD_PA_SECTION_DATA_Set0[] =
{
   {
       8300, /*100kHz*/
      MIPI_USID_PA0_Set0, /*USID*/
...
{
   {
      ...
      MIPI_USID_PA0_Set0, /*USID*/
      {
         ...
         // PA_SEC_DATA0, PA_SEC_DATA1, PA_SEC_DATA2, PA_SEC_DATA3, PA_SEC_DATA4
         // {addr, data}, {addr, data}, {addr, data}, {addr, data}, {addr, data}
         {{ { 0x0, 0x60}, { 0x1, 0x06},{ 0x0, 0x0},  { 0x0, 0x0 }, { 0x0, 0x0 }}},
...
{
   {
      ...
      MIPI_USID_PA0_Set0, /*USID*/
      {
         ...
         // PA_SEC_DATA0, PA_SEC_DATA1, PA_SEC_DATA2, PA_SEC_DATA3, PA_SEC_DATA4
         // {addr, data}, {addr, data}, {addr, data}, {addr, data}, {addr, data}
         {{ { 0x0, 0x28}, { 0x1, 0x0A},{ 0x0, 0x0},  { 0x0, 0x0 }, { 0x0, 0x0 }}},
...
{
   {
      ...
      MIPI_USID_PA0_Set0, /*USID*/
      {
         ...
         // PA_SEC_DATA0, PA_SEC_DATA1, PA_SEC_DATA2, PA_SEC_DATA3, PA_SEC_DATA4
         // {addr, data}, {addr, data}, {addr, data}, {addr, data}, {addr, data}
        {{ { 0x0, 0x70}, { 0x1, 0x07}, { 0x0, 0x0}, { 0x0, 0x0 }, { 0x0, 0x0 }}},      
...
const LTE_MIPI_TPC_SECTION_TABLE_T LTE_Band6_MIPI_DPD_PA_CCA_SECTION_DATA_Set0[] =
{
   {
       8300, /*100kHz*/
      MIPI_USID_PA0_Set0, /*USID*/
