...
/*------------------------------------------------------*/
#define    NUM_OF_HPUE_CLASS2_CA_SetDefault                             3
                                                                        
                                                                        
/*------------------------------------------------------*/              
/*  HPUE_CLASS2_CA_TBL                                  */              
/*------------------------------------------------------*/              
#define    LTE_HPUE_CA_INDICATOR0_band_param_num_SetDefault             2
#define    LTE_HPUE_CA_INDICATOR0_GROUP0_BAND_SetDefault                LTE_Band41
#define    LTE_HPUE_CA_INDICATOR0_GROUP0_ULBW_CLASS_SetDefault          CA_BW_CLAS_A
#define    LTE_HPUE_CA_INDICATOR0_GROUP0_DLBW_CLASS_SetDefault          CA_BW_CLAS_A
#define    LTE_HPUE_CA_INDICATOR0_GROUP1_BAND_SetDefault                LTE_Band41
#define    LTE_HPUE_CA_INDICATOR0_GROUP1_ULBW_CLASS_SetDefault          CA_BW_CLAS_INV
#define    LTE_HPUE_CA_INDICATOR0_GROUP1_DLBW_CLASS_SetDefault          CA_BW_CLAS_A
...
#define    LTE_HPUE_CA_INDICATOR1_band_param_num_SetDefault             1
#define    LTE_HPUE_CA_INDICATOR1_GROUP0_BAND_SetDefault                LTE_Band41
#define    LTE_HPUE_CA_INDICATOR1_GROUP0_ULBW_CLASS_SetDefault          CA_BW_CLAS_A
#define    LTE_HPUE_CA_INDICATOR1_GROUP0_DLBW_CLASS_SetDefault          CA_BW_CLAS_C
...
#define    LTE_HPUE_CA_INDICATOR2_band_param_num_SetDefault             1
#define    LTE_HPUE_CA_INDICATOR2_GROUP0_BAND_SetDefault                LTE_Band41
#define    LTE_HPUE_CA_INDICATOR2_GROUP0_ULBW_CLASS_SetDefault          CA_BW_CLAS_C
#define    LTE_HPUE_CA_INDICATOR2_GROUP0_DLBW_CLASS_SetDefault          CA_BW_CLAS_C
