...
{
   {
      ...
      /*Index 25*/  LTE_FE_RX_SPLIT_SETTING(BAND_SPLIT_INDICATOR0, Part2, Set1),
   }
};
...
{
   {
      ...
      /*Index 25*/  LTE_FE_TX_FILTER_SETTING(BAND_FILTER_INDICATOR0, Set1),
      /*Index 26*/  LTE_FE_TX_FILTER_SETTING(BAND_FILTER_INDICATOR1, Set1),
      /*Index 27*/  LTE_FE_TX_FILTER_SETTING(BAND_FILTER_INDICATOR2, Set1),
      /*Index 28*/  LTE_FE_TX_SPLIT_SETTING(BAND_SPLIT_INDICATOR0, Part2, Set1),
   }
};
...
const LTE_FE_CUSTOM_CCA_BAND_COMB_DATABASE_T LTE_FE_CCA_BAND_COMB_DATABASE_Set1 =
{
   {  /*           { ca_usage,                         , ca_ul_cc_num , ca_dl_cc_num ,   {   CC0_BAND  , CC0_BW_CLAS_UL ,   CC0_BW_CLAS_DL }, BW_COMBINATION_SETS, }*/
      ...
      /*Index   7*/{LTE_CACFG_RX_8B_TX_8A              ,            1 ,            1 ,   {   LTE_Band8 ,   CA_BW_CLAS_A ,     CA_BW_CLAS_B },                 0x1, },
      /*Index   8*/{LTE_CACFG_RX_38C_TX_38A            ,            1 ,            1 ,   {  LTE_Band38 ,   CA_BW_CLAS_A ,     CA_BW_CLAS_C },                 0x1, },
      /*Index   9*/{LTE_CACFG_RX_39C_TX_39A            ,            1 ,            1 ,   {  LTE_Band39 ,   CA_BW_CLAS_A ,     CA_BW_CLAS_C },                 0x1, },
      /*Index  10*/{LTE_CACFG_RX_40C_TX_40A            ,            1 ,            1 ,   {  LTE_Band40 ,   CA_BW_CLAS_A ,     CA_BW_CLAS_C },                 0x3, },
      /*Index  11*/{LTE_CACFG_RX_41C_TX_41A            ,            1 ,            1 ,   {  LTE_Band41 ,   CA_BW_CLAS_A ,     CA_BW_CLAS_C },                 0xF, },
   }
};
