...
#define  MML1_FE_ELNA1_CATEGORY_SetDefault               MML1_ELNA_BYPASS              // B2,  PRX, BPI,  Dynamic mode,     w/o  2nd SAW
#define  MML1_FE_ELNA2_CATEGORY_SetDefault               MML1_ELNA_BYPASS_2ND_SAW      // B2,  PRX, BPI,  Dynamic mode,     w/   2nd SAW
#define  MML1_FE_ELNA3_CATEGORY_SetDefault               MML1_ELNA_ALWAYS_ON           // B2,  PRX, BPI,  On mode,          w/o  2nd SAW
#define  MML1_FE_ELNA4_CATEGORY_SetDefault               MML1_ELNA_ALWAYS_ON_2ND_SAW   // B2,  PRX, BPI,  On mode,          w/   2nd SAW
...
#define  PDATA_MML1_FE_ELNA1_PIN0_SetDefault               6                       // the 1st BPI pin number for the ELNA control, set MML1_ELNA_PIN_NONE if the BPI contorl is not used.
#define  PDATA_MML1_FE_ELNA1_PIN1_SetDefault               7                       // the 2nd BPI pin number for the ELNA control, set MML1_ELNA_PIN_NONE if the BPI contorl is not used.
...
#define  PDATA_MML1_FE_ELNA2_PIN0_SetDefault               6
#define  PDATA_MML1_FE_ELNA2_PIN1_SetDefault               7
