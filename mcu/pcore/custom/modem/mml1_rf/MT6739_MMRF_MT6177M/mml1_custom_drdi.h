...
extern const sMML1_TX_POWER_INDICATION_THRESHOLD_T *mml1CustomTxPwrIndicationParam[MML1_DRDI_REMAP_MMRF_REAL_SET_NUMS];
extern const sMML1_TX_POWER_INDICATION_THRESHOLD_T *mml1_tx_pwr_indication_param_ptr;
