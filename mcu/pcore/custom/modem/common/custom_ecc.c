...
#ifdef __REL5__
static kal_bool   ecc_custom_verify_nw_ecc(
...
static kal_bool   ecc_custom_verify_sim_ecc(
            ecc_call_type_enum call_type,
            kal_uint8 *ecc_category,
            kal_uint8 *ecc_verify,
...
#ifdef __REL5__
    if(ecc_custom_verify_nw_ecc(call_type, ecc_category, ecc_verify, verify_detail) == KAL_TRUE)
    {
        return KAL_TRUE;
        }
#endif /* __REL5__ */
    if(ecc_custom_verify_sim_ecc(call_type, ecc_category, ecc_verify, ecc_display, verify_detail) == KAL_TRUE)
        {
                return KAL_TRUE;
            }
#else 
 ...
 *  kal_bool
 *****************************************************************************/
kal_bool ecc_custom_support_enhance_retry(kal_uint8 ps_id)
{
    kal_bool support;
