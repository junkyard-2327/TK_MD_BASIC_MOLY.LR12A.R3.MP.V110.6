...
const unsigned char   L1D_EPSK_SW_DRDI_enable_Set3 = 1;
#endif

#if IS_ANT_RXPWR_OFFSET_SUPPORT
const sL1D_ANT_RxPWR_Offset_v2_T L1D_ANT_RxPWR_Offset_v2_NVRAM_Set3 = 
{
...
const L1D_CUSTOM_SAR_TX_BACKOFF_DB_NVRAM_T L1_Custom_SAR_TX_BACKOFF_dB_Set3 =
{
   {
