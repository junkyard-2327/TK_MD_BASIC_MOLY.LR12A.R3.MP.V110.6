...
#define L1D_TAS_VERSION_SetDefault                               L1D_TAS_VER_1_0
...
//* LTE Band 5 *//
#define L1D_GSM850_TAS_STATE_NUM_SetDefault                       2
...
#define L1D_GSM850_TAS_STATE3_CAT_A_CONFIG_SetDefault              L1D_TAS_FE_CONFIG1
#define L1D_GSM850_TAS_STATE3_CAT_B_CONFIG_SetDefault              L1D_TAS_FE_CONFIG1
#define L1D_GSM850_TAS_STATE3_CAT_C_CONFIG_SetDefault              L1D_TAS_FE_CONFIG0
#endif /* IS_2G_RXD_SUPPORT */

//* LTE Band 8 *//
#define L1D_GSM900_TAS_STATE_NUM_SetDefault                       2
...
#define L1D_GSM900_TAS_STATE0_CAT_B_CONFIG_SetDefault              L1D_TAS_FE_CONFIG0
...
#define L1D_GSM900_TAS_STATE1_CAT_B_CONFIG_SetDefault              L1D_TAS_FE_CONFIG0
...
#define L1D_GSM900_TAS_STATE2_CAT_B_CONFIG_SetDefault              L1D_TAS_FE_CONFIG1
#define L1D_GSM900_TAS_STATE2_CAT_C_CONFIG_SetDefault              L1D_TAS_FE_CONFIG0

#if IS_2G_RXD_SUPPORT
#define L1D_GSM900_TAS_STATE3_CAT_A_CONFIG_SetDefault              L1D_TAS_FE_CONFIG1
#define L1D_GSM900_TAS_STATE3_CAT_B_CONFIG_SetDefault              L1D_TAS_FE_CONFIG1
#define L1D_GSM900_TAS_STATE3_CAT_C_CONFIG_SetDefault              L1D_TAS_FE_CONFIG0
#endif /* IS_2G_RXD_SUPPORT */

//* LTE Band 3 *//
#define L1D_DCS1800_TAS_STATE_NUM_SetDefault                       2
...
#define L1D_DCS1800_TAS_STATE0_CAT_B_CONFIG_SetDefault              L1D_TAS_FE_CONFIG0
...
#define L1D_DCS1800_TAS_STATE1_CAT_B_CONFIG_SetDefault              L1D_TAS_FE_CONFIG0
...
#define L1D_DCS1800_TAS_STATE2_CAT_B_CONFIG_SetDefault              L1D_TAS_FE_CONFIG1
#define L1D_DCS1800_TAS_STATE2_CAT_C_CONFIG_SetDefault              L1D_TAS_FE_CONFIG0

#if IS_2G_RXD_SUPPORT
#define L1D_DCS1800_TAS_STATE3_CAT_A_CONFIG_SetDefault              L1D_TAS_FE_CONFIG1
#define L1D_DCS1800_TAS_STATE3_CAT_B_CONFIG_SetDefault              L1D_TAS_FE_CONFIG1
#define L1D_DCS1800_TAS_STATE3_CAT_C_CONFIG_SetDefault              L1D_TAS_FE_CONFIG0
#endif /* IS_2G_RXD_SUPPORT */

//* LTE Band 2 *//
#define L1D_PCS1900_TAS_STATE_NUM_SetDefault                       2
...
#define L1D_PCS1900_TAS_STATE0_CAT_B_CONFIG_SetDefault              L1D_TAS_FE_CONFIG0
...
#define L1D_PCS1900_TAS_STATE1_CAT_B_CONFIG_SetDefault              L1D_TAS_FE_CONFIG0
...
#define L1D_PCS1900_TAS_STATE2_CAT_B_CONFIG_SetDefault              L1D_TAS_FE_CONFIG1
#define L1D_PCS1900_TAS_STATE2_CAT_C_CONFIG_SetDefault              L1D_TAS_FE_CONFIG0

#if IS_2G_RXD_SUPPORT
#define L1D_PCS1900_TAS_STATE3_CAT_A_CONFIG_SetDefault              L1D_TAS_FE_CONFIG1
#define L1D_PCS1900_TAS_STATE3_CAT_B_CONFIG_SetDefault              L1D_TAS_FE_CONFIG1
#define L1D_PCS1900_TAS_STATE3_CAT_C_CONFIG_SetDefault              L1D_TAS_FE_CONFIG0
#endif /* IS_2G_RXD_SUPPORT */
...
#if IS_2G_RXD_SUPPORT
#define L1D_GSM850_TAS_TST_STATE3_SetDefault       L1D_TAS_DISABLE
#endif /* IS_2G_RXD_SUPPORT */
...
#if IS_2G_RXD_SUPPORT
#define L1D_GSM900_TAS_TST_STATE3_SetDefault       L1D_TAS_DISABLE
#endif /* IS_2G_RXD_SUPPORT */
...
#if IS_2G_RXD_SUPPORT
#define L1D_DCS1800_TAS_TST_STATE3_SetDefault      L1D_TAS_DISABLE
#endif /* IS_2G_RXD_SUPPORT */
...
#if IS_2G_RXD_SUPPORT
#define L1D_PCS1900_TAS_TST_STATE3_SetDefault      L1D_TAS_DISABLE
#endif /* IS_2G_RXD_SUPPORT */

#if IS_2G_RXD_SUPPORT
#define L1D_RXD_STX_SB_PCL_CB_PRE_SWT_THD_SETDEFAULT  0       /* Increased PCL threshhold in pre switching state (dB) */
#define L1D_RXD_STX_SB_HR_CB_PRE_SWT_THD_SETDEFAULT   1       /* Head room check back threshhold in Pre switching state (dB)*/
#define L1D_RXD_BTX_EVENT_SO_N_CB_SETDEFAULT        (104*4)    /* Number of frames for check back (Frames)*/
#define L1D_RXD_BTX_EVENT_SO_HR_ABS_THD_SETDEFAULT    1       /* Threshhoild indicating almost no power head room dB()*/
#define L1D_RXD_BTX_EVENT_SO_RXLEV_CB_THD_SETDEFAULT  -6      /* RXLEV checkback threshhold (dB)*/
#define L1D_RXD_BRX_EVENT_SO_N_CB_SETDEFAULT        (102*5)   /* Number of frames for check back (Frames)*/
#define L1D_RXD_BRX_EVENT_SO_LOW_QUAL_THD_SETDEFAULT -108     /* Low quality threshhold (dB)*/
#define L1D_RXD_BRX_EVENT_SO_RXLEV_CB_THD_SETDEFAULT  -6      /* RXLEV check back threshhold (dB)*/
#define L1D_RXD_BRX_EVENT_SO_SNR_THD_SETDEFAULT        64     /* Low SNR threshhold (Linear)*/
#define L1D_RXD_BTX_SB_HR_ABS_THD_SETDEFAULT           1      /* Threshhoild indicating almost no power head room (dB)*/
#define L1D_RXD_BTX_SB_PCL_CB_PRE_SWT_THD_SETDEFAULT   0      /* Threshhold of PCL difference before and after pre switching (dB)*/
#define L1D_RXD_BTX_SB_HR_CB_PRE_SWT_THD_SETDEFAULT    1      /* Threshhold of Hr difference before and after pre switching (dB)*/
#define L1D_RXD_BRX_SB_RXLEV_CB_PRE_SWT_THD_SETDEFAULT -2     /* XLEV CB threshhold in pre switching state (dB)*/
#define L1D_RXD_BTX_S_SNR_BLOCK_SETDEFAULT             7      /* Hysteresis for block-average SNR comparison between 2 antennas, need to divide by 8 */
#define L1D_RXD_BRX_S_SNR_BLOCK_SETDEFAULT             6     
#define L1D_RXD_STX_SO_PHR_ABS_THD_SETDEFAULT         1       /* Threshhold indicating hign power level (dB)*/
#define L1D_RXD_STX_SO_PPCL_GAIN_THD_SETDEFAULT       -2      /* Predicted PCL threshhold (dB)*/
#define L1D_RXD_STX_SO_PHR_GAIN_THD_SETDEFAULT        2       /* Predicted head room threshhold (dB)*/
#endif /* IS_2G_RXD_SUPPORT */
