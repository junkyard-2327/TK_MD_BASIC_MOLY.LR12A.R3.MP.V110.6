...
const sGGE_MIPI_CTRL_TABLE_BAND GGE_MIPI_CTRL_TABLE_GSM850_Set3=
{
   {  
      ...
      {  /*            element       data idx       event type       ,  event timing  */
         ...
         {  /*  0 */  GGE_MIPI_ASM ,  {   0  ,  0   },  GGE_MIPI_TRX_ON      ,   QB_MIPI_RX_ON0_Set3   },
         {  /*  1 */  GGE_MIPI_ASM ,  {   1  ,  1   },  GGE_MIPI_TRX_ON      ,   QB_MIPI_RX_ON1_Set3   },
         {  /*  2 */  GGE_MIPI_ASM ,  {   2  ,  2   },  GGE_MIPI_TRX_OFF     ,   QB_MIPI_RX_OFF0_Set3  },
         {  /*  3 */  GGE_MIPI_ANT ,  {   3  ,  3   },  GGE_MIPI_TRX_ON      ,   QB_MIPI_ANT_RX_ON0_Set3   },
         {  /*  4 */  GGE_MIPI_ANT ,  {   4  ,  4   },  GGE_MIPI_TRX_OFF     ,   QB_MIPI_ANT_RX_OFF0_Set3  },
   ...
   {  
      ...
      {  /*            element       data idx       event type       ,  event timing  */
         /*    No.      type   ,  { start, stop },                         ( QB )     */
         {  /*  0 */  GGE_MIPI_ASM ,  {   0  ,  0   },  GGE_MIPI_TRX_ON      ,   QB_MIPI_TX_ON1_Set3   },
         {  /*  1 */  GGE_MIPI_PA  ,  {   1  ,  1   },  GGE_MIPI_TRX_ON      ,   QB_MIPI_TX_ON2_Set3   },
         {  /*  2 */  GGE_MIPI_ASM ,  {   2  ,  2   },  GGE_MIPI_TRX_OFF     ,   QB_MIPI_TX_OFF1_Set3  },
         {  /*  3 */  GGE_MIPI_ANT ,  {   3  ,  3   },  GGE_MIPI_TRX_ON      ,   QB_MIPI_ANT_TX_ON0_Set3   },
         {  /*  4 */  GGE_MIPI_ANT ,  {   4  ,  4   },  GGE_MIPI_TRX_OFF     ,   QB_MIPI_ANT_TX_OFF0_Set3  },
         {  /*  5 */  GGE_MIPI_NULL,  {   0  ,  0   },  GGE_MIPI_EVENT_NULL  ,        0           },
         {  /*  6 */  GGE_MIPI_NULL,  {   0  ,  0   },  GGE_MIPI_EVENT_NULL  ,        0           },
         {  /*  7 */  GGE_MIPI_NULL,  {   0  ,  0   },  GGE_MIPI_EVENT_NULL  ,        0           },
         {  /*  8 */  GGE_MIPI_NULL,  {   0  ,  0   },  GGE_MIPI_EVENT_NULL  ,        0           },
...
const sGGE_MIPI_CTRL_TABLE_BAND GGE_MIPI_CTRL_TABLE_DCS1800_Set3=
{
   ...
   },
   {
      ...
      {  /*            element       data idx       event type       ,  event timing  */
         /*    No.      type   ,  { start, stop },                         ( QB )     */
         {  /*  0 */  GGE_MIPI_ASM ,  {   0  ,  0   },  GGE_MIPI_TRX_ON      ,   QB_MIPI_TX_ON1_Set3   },
         {  /*  1 */  GGE_MIPI_PA  ,  {   1  ,  1   },  GGE_MIPI_TRX_ON      ,   QB_MIPI_TX_ON3_Set3   },
         {  /*  2 */  GGE_MIPI_ASM ,  {   2  ,  2   },  GGE_MIPI_TRX_OFF     ,   QB_MIPI_TX_OFF1_Set3  },
         {  /*  3 */  GGE_MIPI_ANT ,  {   3  ,  3   },  GGE_MIPI_TRX_ON      ,   QB_MIPI_ANT_TX_ON0_Set3   },
         {  /*  4 */  GGE_MIPI_ANT ,  {   4  ,  4   },  GGE_MIPI_TRX_OFF     ,   QB_MIPI_ANT_TX_OFF0_Set3  },
         {  /*  5 */  GGE_MIPI_NULL,  {   0  ,  0   },  GGE_MIPI_EVENT_NULL  ,        0           },
