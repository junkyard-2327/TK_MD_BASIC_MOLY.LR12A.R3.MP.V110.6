...
/* User Notification
    if you want to use DAT feature, please set TL1D_DAT_ENABLE_SetDefault or TL1D_DAT_ENABLE_Set2 or TL1D_DAT_ENABLE_Set1 as 1*/

#define TL1D_DAT_ENABLE_Set2                                 0

/* User Notification
    For each band TL1D_BANDX_DAT_STATEX_CAT_A(B)_CONFIG_Set2: 
