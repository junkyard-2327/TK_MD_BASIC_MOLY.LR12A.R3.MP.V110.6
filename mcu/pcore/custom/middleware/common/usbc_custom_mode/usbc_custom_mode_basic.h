        ...
        {   0x00AD, \
            ...
            { \
                { 2, {USB_CLASS_ACM2, USB_CLASS_ACM2}, \
                     ...
                     {(DATA_IN_DOUBLE_FIFO_ON|DATA_OUT_DOUBLE_FIFO_ON), (DATA_IN_DOUBLE_FIFO_ON|DATA_OUT_DOUBLE_FIFO_ON)} } \
            } \
        }
...
#if ( (defined(__MODEM_CCCI_EXIST__) && !defined(__MODEM_CARD__)) || (defined(MT6595)) || (defined(MT6752) && defined(__MD1__)) || (defined(MT6735)) || !defined(__USB_RNDIS_SUPPORT__) )
    #define _USBMODE_LEGACY_1R3C _USBMODE_META_DBG_COM
#else
    #define _USBMODE_LEGACY_1R3C \
        {   0x7104, \
            0xEF, 0x02, 0x01, \
            1, \
            { \
                { 4, {USB_CLASS_RNDIS, USB_CLASS_ACM1, USB_CLASS_ACM1, USB_CLASS_ACM1}, \
                     ...
                     {(DATA_IN_DOUBLE_FIFO_ON|DATA_OUT_DOUBLE_FIFO_ON), 0x00, 0x00, 0x00} } \
            } \
        }
#endif
