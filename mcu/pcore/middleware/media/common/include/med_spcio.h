...
typedef enum {
	...
	SPCIO_MSG_FROM_SPC_PCMMIXER3_ON_ACK,
	SPCIO_MSG_FROM_SPC_PCMMIXER3_OFF_ACK,
	...
	SPCIO_MSG_FROM_SPC_PCMMIXER3_DL_DATA_REQUEST,
...
typedef struct med_spcBufInfoStruct 
{
   kal_uint16 syncWord;
   kal_uint16 type;
   kal_uint16 length;
...
typedef struct med_spcExtendedBufInfoStruct 
{
   kal_uint16 syncWord;
   kal_uint16 type;
   kal_uint16 length;
...
*/
void SpcIO_MsgQueuePut(SPC_MSG_ID_T msgId, kal_uint32 msgData, kal_uint32 msgDataRev, kal_uint8 callerFrom);
// ----------------------------------------------------------------------------
