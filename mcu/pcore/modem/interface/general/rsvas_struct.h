...
#if defined(__LTE_RAT__) && defined(__MULTIPLE_PS__)
typedef struct {
   LOCAL_PARA_HDR   
   rsvas_id_enum id;
   kal_bool is_protect_req;
} rsvas_eas_protect_tau_service_req_struct;
#endif /* __LTE_RAT__ && __MULTIPLE_PS__ */
...
typedef struct {
   LOCAL_PARA_HDR   
   kal_uint32 owner_sim;
} rsvas_rf_owner_change_ind_struct;
