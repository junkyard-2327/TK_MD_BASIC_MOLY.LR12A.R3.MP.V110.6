 ...
 * $Log$
 *
 * 02 21 2019 willy-wj.chen
 * [MOLY00385419] [Rose][Talbot][p0]The video call UI Will delay down to voice call when tap downgrade button
 * 	
 * 	[R3][TFT_PF] add handling for fragment (1/2) -> other -> fragment (2/2).
 *
...
#define TFTLIB_MAX_NON_PF_IN_CTRL_BUF_NUM 5  //allocate memory from ctrl buf for other purpose (not PF)
