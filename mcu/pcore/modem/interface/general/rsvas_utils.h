...
extern kal_bool rsvas_service_occupy_srlte_enhance(const module_type mod_src, const rsvas_id_enum id, const rsvas_service_type_enum service_type);

extern void rsvas_service_release_srlte_enhance(const module_type mod_src, const rsvas_id_enum id, const rsvas_service_type_enum service_type);
...
extern kal_bool is_rsvas_service_type_in_rsim_owner(const rsvas_sim_enum sim_index, const rsvas_service_type_enum service_type);
#endif
...
extern kal_bool is_rsvas_enter_virtual_suspend_from_connected(const rsvas_sim_enum sim_index);
...
extern kal_bool rsvas_check_tau_protect_existed(void);
