...
typedef struct
{
    ...
    plmn_id_rat_struct epdg_v6_cointainer; // VZ_REQ_LTEDATA_60923 : always set to 311480

    kal_bool req_v4_epdg; //FF02
    plmn_id_rat_struct epdg_v4_cointainer; // VZ_REQ_LTEDATA_60923 : always set to 311480 
