...
typedef enum { 
  IMCSMS_STATUS_START, // start of SMS over IMS
  IMCSMS_STATUS_STOP, // end of SMS over IMS
  IMCSMS_STATUS_NUM, 
} imcsms_status_enum;
...
typedef enum { 
  IMCSMS_SEMAPHORE_TYPE_NONE = 0x00,
  IMCSMS_SEMAPHORE_TYPE_CS   = 0x01,
  IMCSMS_SEMAPHORE_TYPE_HPS  = 0x02,
  IMCSMS_SEMAPHORE_TYPE_MAX  = 0xff 
} imcsms_semaphore_type_enum;
...
/* Location Update Type Values */
typedef enum {
    MM_NORMAL_LU = 0x00,
    MM_PERIODIC_LU = 0x01,
    MM_IMSI_ATTACH_LU = 0x02,
    MM_NONE_ATTEMPTED
} mm_update_type_enum;
