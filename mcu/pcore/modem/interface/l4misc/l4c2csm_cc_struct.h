...
typedef enum
{
   ...
   SRVCC_ECC_CATEGORY_KOREA_REPORTING_SPIES = 0x0003, /*only for korea operator*/
   SRVCC_ECC_CATEGORY_FIRE_BRIGADE = 0x0004,
   SRVCC_ECC_CATEGORY_KOREA_INTELLIGENCE_SERVICE = 0x0006, /*only for korea operator*/
   SRVCC_ECC_CATEGORY_MARINE_GUARD = 0x0008,
   SRVCC_ECC_CATEGORY_KOREA_CUSTOMS_SERVICE = 0x0009, /*only for korea operator*/
   SRVCC_ECC_CATEGORY_MOUNTAIN_RESCUE = 0x0010,
   SRVCC_ECC_CATEGORY_KOREA_SCHOOL_VIOLENCE = 0x0012, /*only for korea operator*/
   SRVCC_ECC_CATEGORY_KOREA_CYBER_TERRORISM = 0x0013, /*only for korea operator*/
...
typedef struct {
    LOCAL_PARA_HDR
} l4ccsm_cc_no_cc_data_detect_ind_struct;
