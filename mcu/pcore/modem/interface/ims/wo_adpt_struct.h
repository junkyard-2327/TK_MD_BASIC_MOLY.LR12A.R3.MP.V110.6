...
typedef em_wo_esp_decrypt_info_add_ind_struct wo_adpt_esp_decrypt_info_ind_struct;

// MSG_ID_WO_ADPT_IKE_DECRYPT_INFO_IND
typedef em_wo_ike_decrypt_info_add_ind_struct wo_adpt_ike_decrypt_info_ind_struct;
