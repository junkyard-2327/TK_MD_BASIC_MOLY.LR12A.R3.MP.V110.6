...
{
   kal_uint8          length;
   l4c_cgauth_info_struct    cgauth_info[ TCM_TOT_CONTEXT ];
...
#if 0 //Unused function, removed as part of function coverage activity
/* under construction !*/
#endif
...
kal_bool l4ctcm_get_cgauth_info(l4c_cgauth_info_list_struct *info);
...
kal_bool l4ctcm_get_context_state_of_ap_view(kal_uint8 *total_context, kal_uint8 *state_list);

void l4ctcm_get_bearer_capability(kal_uint8* valid_contexts, kal_uint8* context_id, data_speed_activate_enum* bearer_capability); //hspa_mmi_h2
...
extern void l4ctcm_set_lte_attach_cid(kal_uint8 lte_attach_cid);
...
void l4ctcm_get_pri_pdp_info_by_context_id_ut(kal_uint8 context_id, l4c_prim_pdp_info_struct *info);
kal_bool l4ctcm_get_context_state_of_ap_view_ut(kal_uint8 *total_context, kal_uint8 *state_list);
void l4ctcm_get_bearer_capability_ut(kal_uint8* valid_contexts, kal_uint8* context_id, data_speed_activate_enum* bearer_capability);
kal_bool l4ctcm_get_pri_pdp_info_ut(l4c_prim_pdp_info_list_struct *info);
kal_bool l4ctcm_get_sec_pdp_info_ut(l4c_sec_pdp_info_list_struct *info);
kal_uint8 l4ctcm_get_nw_applied_pdp_addr_type_ut(kal_uint8 cid);
kal_bool l4ctcm_get_qos_info_ut(atci_qos_enum type, l4c_qos_list_struct *info);
kal_bool l4ctcm_set_tft_info_ut(tft_info_struct *info);
kal_bool l4ctcm_get_tft_info_ut(tft_info_struct *info);
kal_bool l4ctcm_get_eqos_info_ut(atci_qos_enum type, l4c_eqos_list_struct *info);
kal_bool l4ctcm_get_config_option_info_ut(l4c_config_option_list_struct *info);
kal_bool l4ctcm_get_cgauth_info_ut(l4c_cgauth_info_list_struct *info);
kal_bool l4ctcm_get_eps_qos_info_ut(l4c_eps_qos_list_struct *info);
kal_bool l4ctcm_undef_egdelpf_ut(kal_uint8 cid);
kal_bool l4ctcm_set_egdelpf_ut(kal_uint8 cid, kal_uint8 pf_id);
kal_bool l4ctcm_get_eglnkpf_ut(kal_uint8 cid, kal_uint8 *pf_total_num, kal_uint8 *pf_list);
kal_bool l4ctcm_undef_eglnkpf_ut(kal_uint8 cid);
kal_bool l4ctcm_get_nw_applied_pdp_addr_ut(kal_uint8 cid, kal_uint8 *length, kal_uint8 *addr, kal_bool c2k_irat_ongoing);
kal_bool l4ctcm_get_sec_pdp_rdp_info_ut(kal_uint8 cid, l4c_sec_pdp_rdp_info_struct *info);
kal_bool l4ctcm_get_eps_qos_rdp_info_ut(kal_uint8 cid, l4c_eps_qos_rdp_struct *info);
kal_bool l4ctcm_get_tft_rdp_info_ut(tft_info_struct *info);
kal_bool l4ctcm_undef_cgtft_ut(kal_uint8 cid);
kal_bool l4ctcm_get_egdelpf_ut(kal_uint8 cid, kal_uint8 *pf_total_num, kal_uint8 *pf_list);
kal_bool l4ctcm_get_context_state_ut(kal_uint8 *total_context, kal_uint8 *state_list);
kal_bool check_pdp_context_exist_func_ut(void);
#endif
