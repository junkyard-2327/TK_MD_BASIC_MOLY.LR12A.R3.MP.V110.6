...
TRC_MSG(RAC_TRC_rac_e_change_vdp_by_roaming, "rac_e_change_vdp_by_roaming")
TRC_MSG(RAC_TRC_rac_ug_change_vdp_by_roaming, "rac_ug_change_vdp_by_roaming")
...
/*GSMA SIM invalid feature*/
TRC_MSG(RAC_TRC_DEREG_REQ_TO_GMSS_ONLY, "[RAC] This DEREG_REQ shall send to GMSS only")
TRC_MSG(RAC_TRC_DEREG_REQ_NOT_SEND, "[RAC] This DEREG_REQ shall be block by upper layer")
TRC_MSG(RAC_TRC_BLOCK_SEARCH_WHEN_ILLEGAL_ME, "[RAC] This search shall be block by RAC due to sim invalid state")
...
TRC_MSG(RAC_TRC_READ_EF_IMSI_FOR_EMM_INFO, "[RAC] read NVRAM_EF_IMSI_FOR_EMM_INFO_LID back")
...
TRC_MSG(RAC_TRC_CHANGE_UEMODE_BY_CDMA2000_LTE_ONLY, "[RAC] Change UE mode to ps mode 1 due to cdma2000 condition and lte only reported rat")
...
TRC_MSG(RAC_TRC_CLEAR_CAUSE18_WHEN_DETACH, "[RAC] KOR requirement to clear cause 18 when detach,  enter_cause18=%Mkal_bool")
#endif /* __LTE_RAT__ */
TRC_MSG(RAC_TRC_HPLMN_RECORD_FLAG, "[RAC] hplmn_record_flag = %Mkal_bool")
TRC_MSG(RAC_TRC_CURRENT_MSG_ID, "[RAC] msg_id = %Mmsg_type, local_para_ptr:0x%08x")
TRC_MSG(RAC_TRC_COVERT_TO_U32_PLMN_ID, "[RAC] covert to u32 plmn_id = %d")
TRC_MSG(RAC_TRC_IGNORE_CAUSE18_PLMN, "[RAC] ignore the cause18 plmn update")
...
TRC_MSG(RAC_DISABLE_LTE_DATA_ROAMING_SETTING, "[RAC] disable_lte_data_roaming_support: %Mkal_bool")
#endif
...
TRC_MSG(RAC_VDP_ONLY_CONFIG_BY_SIM, "[RAC] not hit, VDP by sim %d only")

TRC_MSG(RAC_VDP_CONFIG_BY_ROAMING, "[RAC] VDP by roaming %d")
TRC_MSG(RAC_CHANGE_VDP_BY_ROAMING, "[RAC] Change VDP setting by roaming to %d")
...
//TRC_MSG(RAC_NOT_CHANGE_VDP_SINCE_VDP_IS_SET, "[RAC] Since VDP is set by AT CMD, do not change VDP setting")
TRC_MSG(RAC_NOT_CHANGE_VDP_SINCE_VDP_PROVISION_FROM_NW, "[RAC] Since VDP is got provision from NW, do not change VDP setting")
...
TRC_MSG(RAC_DISPLAY_OPTIMIZATION_START, "[RAC] RAC_DISPLAY_OPTIMIZATION_START")
TRC_MSG(RAC_DISPLAY_OPTIMIZATION_END, "[RAC] RAC_DISPLAY_OPTIMIZATION_END")
TRC_MSG(RAC_ATOMIC_UPDATE_NVRAM_RAT_MODE, "[RAC] rac_atomic_update_nvram_rat_mode rec_idx:%d before switch:%Mrat_mode_enum, nv_rat_mode:%Mrat_mode_enum")

TRC_MSG(RAC_DISPLAY_OPTIMIZATION_MPSR,"[RAC]RAC_DISPLAY_OPTIMIZATION_MPSR")
...
TRC_MSG(RAC_TRC_FORWARD_MSG_ID, "[RAC] forward %Mmsg_type -> %Mmsg_type")
