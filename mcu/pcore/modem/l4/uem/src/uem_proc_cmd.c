...
void l4cuem_em_rf_test_gsm_req(kal_uint8 src_id, kal_uint8 request_type, rf_test_gsm_param_struct request)
{
    ...
    switch(request_type)
    {
        ...
        case RF_TEST_GSM_TX_TEST:
        {
            ...
            {
                uem_send_msg_to_l1(MSG_ID_L4CL1_EM_RF_TEST_GSM_STOP_REQ, NULL);
                kal_sleep_task( 13 );        //Requested by L1 to avoid Race condition
            }
            ...
            ((rf_test_gsm_tx_test_struct*)local_data_ptr)->src_id = src_id;
#endif//#if defined(__ATERFTX_ERROR_HANDLE_ENHANCE__)
...
#if defined(__ATERFTX_ERROR_HANDLE_ENHANCE__)
            ((rf_test_gsm_rx_test_struct*)local_data_ptr)->src_id = src_id;
#endif//#if defined(__ATERFTX_ERROR_HANDLE_ENHANCE__)
...
#if defined(__ATERFTX_ERROR_HANDLE_ENHANCE__)
            ((rf_test_gsm_power_scan_struct*)local_data_ptr)->src_id = src_id;
#endif//#if defined(__ATERFTX_ERROR_HANDLE_ENHANCE__)
        ...
        case RF_TEST_GSM_RX_TEST_TWO_PATH:
        {
            rf_test_gsm_rx_test_two_path_struct *req = &(request.gsm_rx_test_2_path);
            ...
            local_data_ptr = (rf_test_gsm_rx_test_two_path_struct*) construct_local_para(sizeof(rf_test_gsm_rx_test_two_path_struct), TD_CTRL);
#if defined(__ATERFTX_ERROR_HANDLE_ENHANCE__)
            ((rf_test_gsm_rx_test_two_path_struct*)local_data_ptr)->src_id = src_id;
#endif//#if defined(__ATERFTX_ERROR_HANDLE_ENHANCE__)
            
            ((rf_test_gsm_rx_test_two_path_struct*)local_data_ptr)->band = req->band;
            ((rf_test_gsm_rx_test_two_path_struct*)local_data_ptr)->arfcn = req->arfcn;
            ((rf_test_gsm_rx_test_two_path_struct*)local_data_ptr)->gain_prx = req->gain_prx;
            ((rf_test_gsm_rx_test_two_path_struct*)local_data_ptr)->gain_drx = req->gain_drx;
            ((rf_test_gsm_rx_test_two_path_struct*)local_data_ptr)->pattern = req->pattern;
            
            uem_send_msg_to_l1(MSG_ID_L4CL1_EM_RF_TEST_GSM_RX_TEST_TWO_PATH_REQ, local_data_ptr);
