...
extern kal_bool rat_tcm_pending_act(kal_uint8 context_num);
extern kal_bool rat_tcm_pending_deact(kal_uint8 context_num);
extern kal_bool rat_tcm_pending_mod(kal_uint8 context_num);
...
extern void rat_tcm_mark_processing_time_timestamp(kal_uint8 context_num);
extern kal_uint32 rat_tcm_determine_user_triggered_deact_processing_time_limit_in_secs(kal_uint8 context_num);
extern void rat_tcm_mark_user_triggered_deact_processing_time_timestamp(kal_uint8 context_num);
extern void rat_tcm_send_pdp_deactivate_ntf(kal_uint8 context_id);
