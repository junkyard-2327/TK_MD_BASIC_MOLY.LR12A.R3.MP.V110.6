...
#define VALUE_OF_RAT_TCM_IRAT_QUEUE_TIMER_CONTEXT(X)  ((rat_tcm_ptr_g)->queuedtimer_event.X)
#define RAT_TCM_IRAT_QUEUE_TIMER_CONTEXT()  ((rat_tcm_ptr_g)->queuedtimer_event)
