...
TRC_MSG(RAT_TCM_TRACE_INFO_START_IRAT_QUEUE_TIMER, "rat_tcm_start_irat_queue_timer() : Start IRAT Queue Tick Timer")
TRC_MSG(RAT_TCM_TRACE_INFO_STOP_IRAT_QUEUE_TIMER, "rat_tcm_stop_irat_queue_timer() : Stop IRAT Queue Tick Timer")
TRC_MSG(RAT_TCM_TRACE_INFO_FAIL_TO_STOP_IRAT_QUEUE_TIMER, "rat_tcm_stop_irat_queue_timer() : Fail To Stop timer (still pending ilm for cid %d)")
...
TRC_MSG(RAT_TCM_TRACE_INFO_REMAINING_PROCESSING_TIME_LIMIT_IN_SECS, "Processing Time: %u, Current Time: %u, Remaining Time: %u")
TRC_MSG(RAT_TCM_PREVENT_DROPPING_QUEUED_ILM, "rat_tcm_retry_failed_req_and_process_queued_req_during_irat() Did not drop Emergency ACT REQ from queue")
TRC_MSG(RAT_TCM_TRACE_INFO_DETERMINE_USER_TRIGGERED_DEACT_PROCESSING_TIME_LIMIT_IN_SECS, "rat_tcm_determine_user_triggered_deact_processing_time_limit_in_secs: processing_time_limit_in_secs %u -> %u")
TRC_MSG(RAT_TCM_TRACE_INFO_PROCESSING_TIME_CONTEXT_ID_INFO, "processing_time_limit_left_in_secs: %u Context Id %u")
TRC_MSG(RAT_TCM_TRACE_INFO_QUEUED_INFO, "is_queued_act: %d, is_queued_mod: %d, is_queued_deact: %d")
TRC_MSG(RAT_TCM_TRACE_INFO_DEACT_REQ_PROGRESS, "deact_req_progress is not RAT_TCM_REQ_QUEUED_AND_TCM_PROCESSING for context_num: %d so Return")
TRC_MSG(RAT_TCM_TRACE_INFO_DEACT_REQ_MSG, "No DEACTIVATE_REQ in queue for context_num %d so Return")
TRC_MSG(RAT_TCM_TRACE_INFO_SEND_DEACT_NTF, "call rat_tcm_send_pdp_deactivate_ntf for context_id: %d")
TRC_MSG(RAT_TCM_TRACE_INFO_SEND_DEACT_NTF_ON_DEACT_FAIL, "call rat_tcm_send_pdp_deactivate_ntf on deact fail for context_num: %d")
