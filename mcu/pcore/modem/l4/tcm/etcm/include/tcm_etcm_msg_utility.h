...
l4bpdn_tcm_pf_update_ind_struct     *etcm_cidGenL4bpdnPfUpdateInd   (void *parent, etcm_cid_struct cid, tft_info_struct *tftInfo, kal_bool tft_present, kal_bool isESM_mo);
l4bpdn_tcm_bearer_act_ind_struct    *etcm_cidGenL4bpdnActInd        (void *parent, etcm_cid_struct cid, tft_info_struct *tftInfo, kal_bool tft_present, kal_bool isESM_mo);
l4bpdn_tcm_bearer_deact_ind_struct  *etcm_cidGenL4bpdnDeactInd      (etcm_cid_struct cid);
l4bpdn_tcm_pco_rdp_update_ind_struct    *etcm_cidGenL4bpdnPcoRdpUpdateInd   (etcm_cid_struct cid);
