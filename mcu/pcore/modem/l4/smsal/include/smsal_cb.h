...
void smsal_cbch_req_handler(kal_uint8 src, kal_uint8 cbch_req, smsal_cb_cmd_enum cb_cmd);
...
void smsal_cb_update_ratcm_rmc_cb(smsal_cb_cmd_enum cb_cmd);
...
void smsal_cb_update_eval_rmc_cb(smsal_cb_cmd_enum cb_cmd);
...
void smsal_cb_update_rmc_cb(smsal_cb_cmd_enum cb_cmd);

void smsal_cb_service_by_plmn_handler(local_para_struct *local_para_ptr);

void smsal_cb_init_aux_info(smsal_set_cb_aux_info_struct *aux_info, smsal_cb_cmd_enum cb_cmd);
...
kal_uint8 smsal_cb_check_timer_exists(kal_uint16 mi, kal_uint16 sn);

kal_uint8 smsal_cb_find_free_dup_det_timer_id();

void smsal_cb_start_duplicate_detection_timer(kal_uint16 mi, kal_uint16 sn);

void smsal_cb_gs_change_ind_handler(kal_uint8 geographical_scope);
