...
typedef enum {
	SMSAL_EMPTY_SMS_00FF,
	SMSAL_EMPTY_SMS_0000
}smsal_sim_search_record_pattern_enum;
...
typedef enum
{
   ...
   SMSAL_LA_CHANGED,
   SMSAL_PLMN_CHANGED,
   SMSAL_NUM_OF_GS_CHANGED
} smsal_cb_geography_enum;

#if defined (__SENSITIVE_DATA_MOSAIC__)
typedef enum{
   SMSAL_DIR_MO,
   SMSAL_DIR_MT
}smsal_direction_enum;
#endif
