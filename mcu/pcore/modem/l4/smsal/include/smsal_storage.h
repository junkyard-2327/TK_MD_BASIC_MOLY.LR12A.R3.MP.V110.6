...
void smsal_read_fileinfo_from_sim(kal_uint8        access_id,
                                  ...
                                  kal_uint8        info_type);
/*
* To find the records in a SIM with particular pattern 
*/
void smsal_sim_search_record(kal_uint8        access_id,
							 smsal_file_enum  file_id,
...
void smsal_copy_common_param_to_buffer(smsal_nvm_common_param_struct *nvm_buffer);

void smsal_fill_common_param_context_from_buffer(smsal_nvm_common_param_struct *nvm_buffer);
