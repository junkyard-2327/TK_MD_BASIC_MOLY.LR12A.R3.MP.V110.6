...
#if defined(__CB__)
#define SMSAL_CB_DUP_DETECTION_MAX_TIMER_ITEM  100
#else
#define SMSAL_CB_DUP_DETECTION_MAX_TIMER_ITEM  0
#endif

#define SMSAL_MAX_TIMER_ITEM   (2+SMSAL_CB_TIMER_ITEM+SMSAL_CB_DUP_DETECTION_MAX_TIMER_ITEM) /* 2 for cnma timer  */
...
#ifdef __SMSAL_UT__
#define SMSAL_CB_DUP_DET_TIMEOUT_TICK   (5*KAL_TICKS_1_SEC)            /* 24 hrs */
#define SMSAL_CB_JP_DUP_DET_TIMEOUT_TICK   (10*KAL_TICKS_1_SEC )            /* 1 hr */
#else
#define SMSAL_CB_DUP_DET_TIMEOUT_TICK   (24*60*KAL_TICKS_1_MIN )            /* 24 hrs */
#define SMSAL_CB_JP_DUP_DET_TIMEOUT_TICK   (60*KAL_TICKS_1_MIN )            /* 1 hr */
#endif
#define SMSAL_GEO_SCOPE_LA_SA_WIDE 0x8000
#define SMSAL_GEO_SCOPE_PLMN_WIDE 0x4000
#define SMSAL_GEO_SCOPE_CELL_WIDE_IMMEDIATE 0x0000
#define SMSAL_GEO_SCOPE_CELL_WIDE_NORMAL 0xc000
