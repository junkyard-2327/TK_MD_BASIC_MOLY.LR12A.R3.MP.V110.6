...
#define SMSAL_VM_INALID_SIM_RECORD_NO (kal_uint16)(0xFFFF)
...
struct _read_file_aux_info_struct
{
   ...
   kal_uint8*			 search_record_result; /*Pointer to hold the SIM_SEARCH_RECORD result*/
};
...
typedef struct
{  
   kal_uint8                     ori_para_ind; /* original para_ind (smsal_cb_para_enum) */
   kal_uint8                     para_ind; /* smsal_cb_sub_act_enum */
...
typedef struct
{
   ...
   kal_uint16 mi;   
   kal_uint16 sn;  
}smsal_cb_dup_detect_timer_info_struct;
...
typedef enum
{
    SMSAL_EF_CBMI_WRITE_FAIL_NONE,
    SMSAL_EF_CBMI_WRITE_FAIL_TEMP,
    SMSAL_EF_CBMI_WRITE_FAIL_PERM
}smsal_sim_write_rej_cause_enum;
...
typedef struct
{
   ...
   peer_buff_struct                      *peer_buff_ptr;
    ...
    smsal_sim_write_rej_cause_enum       update_ef_cbmi_fail_type;
    ...
    smsal_cb_dup_detect_timer_info_struct cb_dup_detect_timer_info[SMSAL_CB_DUP_DETECTION_MAX_TIMER_ITEM];
