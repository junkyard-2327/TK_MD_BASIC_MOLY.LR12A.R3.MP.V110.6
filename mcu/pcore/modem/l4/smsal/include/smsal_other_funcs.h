...
extern void smsal_dsbp_reconfigure_ind_hdlr(ilm_struct *ilm_ptr);

#if defined (__SENSITIVE_DATA_MOSAIC__)
extern void smsal_mask_sensitive_data(kal_uint32 global_peer_msg_id,peer_buff_struct *peer_buff_ptr,kal_uint32 trace_index,smsal_peer_msg_name_enum msg_name,smsal_direction_enum direction);

extern void smsal_query_mt_offset(protocol_id_enum ps_id, kal_uint16 *off_oa_from_end ,kal_uint16 *off_txt_from_end);

extern void smsal_query_mo_offset(protocol_id_enum ps_id, kal_uint16 *off_da_from_end ,kal_uint16 *off_txt_from_end);

extern void smsal_set_mt_offset(protocol_id_enum ps_id, kal_uint16 off_oa_from_end ,kal_uint16 off_txt_from_end);

extern void smsal_set_mo_offset(protocol_id_enum ps_id, kal_uint16 off_da_from_end ,kal_uint16 off_txt_from_end);

extern void sms_update_offset(peer_buff_struct * peer_buff_ptr);

extern kal_bool smsal_status_report_pdu_check_and_update_offset( protocol_id_enum ps_id, kal_uint8 *pdu_ptr, kal_uint16 pdu_len, smsal_error_cause_enum *error_cause);

extern kal_bool smsal_deliver_pdu_check_and_update_offset(protocol_id_enum ps_id, kal_uint8 *pdu_ptr,kal_uint16 pdu_len, smsal_error_cause_enum *error_cause);

extern kal_bool smsal_submit_pdu_check_and_update_offset(protocol_id_enum ps_id, kal_uint8 *pdu_ptr,kal_uint16 pdu_len,smsal_error_cause_enum *error_cause,kal_bool is_sca_present);
