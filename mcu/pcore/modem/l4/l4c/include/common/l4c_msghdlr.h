...
extern void l4c_lbs_active_sim_req_hdlr(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);

extern void l4c_me_reconfigure_req_hdlr(local_para_struct *local_para_ptr, module_type src_mod_id);
...
extern void l4c_normal_meta_mode_switch_hdlr(ilm_struct *ilm_ptr);

extern void l4c_c2k_power_off_cnf_hdlr(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);

#ifdef __DISABLE_SIM_RESET_DURING_DUPLEX_MODE_CHANGE__
extern void sim_duplex_mode_cnf_hdlr(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);
#endif
...
#endif
extern void l4c_general_modem_configure_set_cnf_hdlr(local_para_struct *local_para_ptr, peer_buff_struct * peer_buff_ptr);
extern void l4c_general_modem_configure_query_cnf_hdlr(local_para_struct *local_para_ptr, peer_buff_struct * peer_buff_ptr);
extern void l4c_rb_test_mode_info_ind_hdlr(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);
