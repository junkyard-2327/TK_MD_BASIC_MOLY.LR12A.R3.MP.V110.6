...
typedef enum
{
    #define EXTEND_CMD(AT_NAME, HASH1, HASH2, TEST_STRING, ENUM, FUNC) __##ENUM##__,
    #define CMD_ENUM(ENUM)
        #include "at_usir_cmd.h"
    #undef EXTEND_CMD
    #undef CMD_ENUM

    RMMI_TOT_USIR_CMD
} rmmi_usir_cmd_id_enum;
...
extern kal_uint32 const rmmi_usir_cmd_table[RMMI_TOT_USIR_CMD][2]; 

extern rmmi_cmd_id_enum const rmmi_usir_cmd_id_table[RMMI_TOT_USIR_CMD]; 
