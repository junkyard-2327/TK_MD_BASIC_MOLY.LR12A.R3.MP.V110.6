...
extern void rmmi_send_rsp_to_SAT(kal_bool result);
extern void rmmi_rsp_to_SAT(kal_uint8 *buffer, kal_uint16 length, kal_bool stuff, kal_bool result);
...
extern void atci_l4bpwr_cfun_0_req_hdlr(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);

extern void l4bpwr_atci_epof_req_hdlr(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);

extern l4c_scp_monitor_enum rmmi_read_data_from_tty_port(kal_uint8 port);

extern void rmmi_dsbp_reconfigure_ind_hdlr(void *local_para_ptr);
