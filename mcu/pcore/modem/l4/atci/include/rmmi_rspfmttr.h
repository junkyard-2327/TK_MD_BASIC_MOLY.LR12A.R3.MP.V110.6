...
extern void rmmi_clcc_read_rsp_fmttr(l4c_call_entry_struct call_entry, l4c_number_struct addr, kal_bool is_clccs);

extern void rmmi_clcc_to_clccs_read_rsp(l4c_call_entry_struct call_entry, l4c_number_struct addr);
...
extern void rmmi_cops_test_rsp_fmttr(kal_uint8 length, l4c_rat_plmn_info_struct *list);
...
extern void rmmi_eplwss_rsp_fmttr(kal_uint8 length, l4c_rat_plmn_info_struct *list);
