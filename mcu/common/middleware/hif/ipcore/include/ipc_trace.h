...
BEGIN_TRACE_MAP(MOD_IPCORE)
    ...
    TRC_MSG(IPC_TR_SESSION_BINDING_START, "[IPCORE] ipc_on_pdn_bind_top(): binding request received")
    TRC_MSG(IPC_TR_SESSION_BINDING_INFO, "[IPCORE] ipc_on_pdn_bind_top(): network_interface_id(0x%X), pdn_id(0x%X), ip_addr_type(%d)...")
    TRC_MSG(IPC_TR_SESSION_BINDING_CFG_IP_INFO, "[IPCORE] ipc_on_pdn_bind_bot(): Configure IP information for network_interface_id(0x%X), pdn_id(0x%X), ip_addr_type(%d):Mapped NMU ip_id(%d)")
    TRC_MSG(IPC_TR_SESSION_BINDING_CFG_IPV6_DNS, "[IPCORE] ipc_on_pdn_bind_bot(): Add IPv6 DNS to NMU ip_id(%d):[%02X] %02x%02x:%02x%02x:%02x%02x:%02x%02x:%02x%02x:%02x%02x:%02x%02x:%02x%02x")
    TRC_MSG(IPC_TR_SESSION_BINDING_CFG_IPV6_DNS_NUM, "[IPCORE] ipc_on_pdn_bind_bot(): Set IPv6 DNS number(%d) to NMU ip_id(%d)")
    TRC_MSG(IPC_TR_SESSION_BINDING_CFG_IPV6_ZERO_IID_LEN, "[IPCORE] ipc_on_pdn_bind_bot(): Set IPv6 IID length of NMU ip_id(%d) to ZERO")
    TRC_MSG(IPC_TR_SESSION_BINDING_CFG_IPV6_IID, "[IPCORE] ipc_on_pdn_bind_bot(): Set IPv6 IID to NMU ip_id(%d):IID length(%d) %02x%02x:%02x%02x:%02x%02x:%02x%02x:%02x%02x:%02x%02x:%02x%02x:%02x%02x")
    TRC_MSG(IPC_TR_SESSION_BINDING_CFG_IPV6_DOWN, "[IPCORE] ipc_on_pdn_bind_bot(): NMU ip_id(%d) - IPv6 DOWN")
    TRC_MSG(IPC_TR_SESSION_BINDING_CFG_IPV6_UP, "[IPCORE] ipc_on_pdn_bind_bot(): NMU ip_id(%d) - IPv6 UP")
    TRC_MSG(IPC_TR_SESSION_BINDING_CFG_IPV4_DNS, "[IPCORE] ipc_on_pdn_bind_bot(): Add IPv4 DNS to NMU ip_id(%d):[%02X] %d.%d.%d.%d")
    TRC_MSG(IPC_TR_SESSION_BINDING_CFG_IPV4_DNS_NUM, "[IPCORE] ipc_on_pdn_bind_bot(): Set IPv4 DNS number(%d) to NMU ip_id(%d)")
    TRC_MSG(IPC_TR_SESSION_BINDING_CFG_IPV4_ADDR, "[IPCORE] ipc_on_pdn_bind_bot(): Set IPv4 address to NMU ip_id(%d): %d.%d.%d.%d")
    TRC_MSG(IPC_TR_SESSION_BINDING_CFG_IPV4_FAKE_INFO, "[IPCORE] ipc_on_pdn_bind_bot(): NMU ip_id(%d) - Trigger IPv4 fake info generation for IPv4 address %d.%d.%d.%d")
    TRC_MSG(IPC_TR_SESSION_BINDING_CFG_IPV4_UP, "[IPCORE] ipc_on_pdn_bind_bot(): NMU ip_id(%d) - IPv4 UP")
    TRC_MSG(IPC_TR_SESSION_BINDING_CFG_IPV4_DOWN, "[IPCORE] ipc_on_pdn_bind_bot(): NMU ip_id(%d) - IPv4 DOWN")
    TRC_MSG(IPC_TR_SESSION_BINDING_DHCP4C, "[IPCORE] ipc_on_pdn_bind_bot(): Enable DHCP4C for netif_id(%d), features(0x%X)")
    TRC_MSG(IPC_TR_SESSION_BIND_SESSION_RLOCK_FAIL, "[IPCORE] ipc_on_pdn_bind_bot(): session readlock is failed for network_card(0x%X), pdn_id(0x%X)!")
    TRC_MSG(IPC_TR_SESSION_BIND_NEW_SESSION_FAIL, "[IPCORE] ipc_on_pdn_bind_top(): session allocation is failed for network_card(0x%X), pdn_id(0x%X), ip_type(0x%X)!")
    TRC_MSG(IPC_TR_SESSION_BIND_INVALID_NETIF, "[IPCORE] ipc_on_pdn_bind_top(): no netif found for network_card(0x%X)!")
    TRC_MSG(IPC_TR_SESSION_BIND_UNSUPPORTED_IP_ADDR_TYPE, "[IPCORE] ipc_on_pdn_bind_top(): unsupported ip_addr_type(%d)! pdn_id(0x%X)")
    TRC_MSG(IPC_TR_SESSION_BIND_NULL_PARAM, "[IPCORE] ipc_on_pdn_bind_top(): NULL parameter!")
    ...
    TRC_MSG(IPC_TR_SESSION_BINDING_RESULT, "[IPCORE] ipc_on_pdn_bind_bot(): binding request handling - result(0x%X)")
    TRC_MSG(IPC_TR_SESSION_BINDING_RSP_PARAM_GEN, "[IPCORE] ipc_on_pdn_bind_bot(): Generate binding response parameter - network_interface_id(%d), pdn_id(%d), sizeof(ip_addr_struct)=%d, sizeof(dns_struct)=%d, sizeof(upcm_ipcore_back_info_t)=%d")
    TRC_MSG(IPC_TR_SESSION_BINDING_RSP, "[IPCORE] ipc_on_pdn_bind_bot(): sending response for binding request - result(0x%X), dst_module(0x%X)")
    ...
    TRC_MSG(IPC_TR_SESSION_DEACTIVATING, "[IPCORE] ipc_on_pdn_unbind(): pdn_id(0x%X)...")
    TRC_MSG(IPC_TR_SESSION_DEACTIVATE_NO_SESSION_FOUND, "[IPCORE] ipc_on_pdn_unbind(): no session found for pdn_id(0x%X)!")
    TRC_MSG(IPC_TR_SESSION_DEACTIVATE_NULL_PARAM, "[IPCORE] ipc_on_pdn_unbind(): NULL parameter!")
    ...
    TRC_MSG(IPC_TR_SESSION_REBINDING_INFO, "[IPCORE] ipc_on_pdn_rebind(): network_interface_id(0x%X), old_pdn_id(0x%X), new_pdn_id(0x%X), ip_addr_type(%d)...")
    TRC_MSG(IPC_TR_SESSION_REBIND_UNSUPPORTED_IP_ADDR_TYPE, "[IPCORE] ipc_on_pdn_rebind(): unsupported ip_addr_type(%d)! new_pdn_id(0x%X)")
    TRC_MSG(IPC_TR_SESSION_REBIND_REPLACE_SESSION_FAIL, "[IPCORE] ipc_on_pdn_rebind(): old session deletion or session allocation is failed for network_card(0x%X), old_pdn_id(0x%X), new_pdn_id(0x%X)!")
    TRC_MSG(IPC_TR_SESSION_REBIND_SESSION_RLOCK_FAIL, "[IPCORE] ipc_on_pdn_rebind(): session readlock is failed for network_card(0x%X), old_pdn_id(0x%X)!")
    TRC_MSG(IPC_TR_SESSION_REBIND_INVALID_NETIF, "[IPCORE] ipc_on_pdn_rebind(): no netif found for network_card(0x%X)!")
    TRC_MSG(IPC_TR_SESSION_REBIND_NULL_PARAM, "[IPCORE] ipc_on_pdn_rebind(): NULL parameter!")
    TRC_MSG(IPC_TR_SESSION_REBINDING_RESULT, "[IPCORE] ipc_on_pdn_rebind(): binding request handling - result(0x%X)")
    TRC_MSG(IPC_TR_SESSION_REBINDING_RSP_PARAM_GEN, "[IPCORE] ipc_on_pdn_rebind(): Generate rebinding response parameter - network_interface_id(%d), old_pdn_id(%d), new_pdn_id(%d), sizeof(ip_addr_struct)=%d, sizeof(dns_struct)=%d, sizeof(upcm_ipcore_back_info_t)=%d")
    TRC_MSG(IPC_TR_SESSION_REBINDING_RSP, "[IPCORE] ipc_on_pdn_rebind(): sending response for binding request - result(0x%X), dst_module(0x%X)")
    TRC_MSG(IPC_TR_SESSION_REBIND_START, "[IPCORE] ipc_replace_session(): Replace session - netif(0x%X), old_session(0x%X), new_session_context(0x%X), new_session_type(0x%X), new_session_state(0x%X).")
    TRC_MSG(IPC_TR_SESSION_REPLACED, "[IPCORE] ipc_replace_session(): session_context(0x%X), session_type(0x%X), session_state(0x%X) has been replaced successfully => ip_id(%d)")
    TRC_MSG(IPC_TR_SESSION_REPLACE_NETIF_RLOCK_FAIL, "[IPCORE] ipc_replace_session(): netif readlock is failed!")
    TRC_MSG(IPC_TR_SESSION_REPLACE_SESSION_RLOCK_FAIL, "[IPCORE] ipc_on_pdn_rebind(): session readlock is failed!")
    ...
    TRC_MSG(IPC_TR_META_UL_DROP_FOR_SESSION_DEACT, "[IPCORE] netif_id(0x%X) drops uplink packet META(0x%x) ip_type(%d) for session deactivated!")
    TRC_MSG(IPC_TR_META_UL_DROP_FOR_INVALID_NETIF, "[IPCORE] netif_id(0x%X) drops uplink packet [META: idx(%d), q_type(%d)] for invalid netif!")
    TRC_MSG(IPC_TR_META_UL_DROP_FOR_NONE_IP_PKT, "[IPCORE] netif_id(0x%X) Found non-IPv4/IPv6 packet [META: idx(%d), q_type(%d)], drop!")
    TRC_MSG(IPC_TR_META_UL_DROP_FOR_UL_DISABLE, "[IPCORE] Drops uplink packet [META: start_idx(%d), end_idx(%d), q_type(%d)] for uplink traffic disabled!")
    TRC_MSG(IPC_TR_META_UL_DROP_FOR_LAN_DID_ALLOC_FAIL, "[IPCORE] lan netif_id(%d) drops uplink packet META(0x%x) ip_type(%d) for lan DID allocation failed!")
    ...
    TRC_MSG(IPC_TR_MDT_DROP_FOR_LAN_NETIF_DETACH, "[IPCORE] drops type(%d) head_ior(0x%X) downlink packets for lan netif detached!")
    ...
    TRC_MSG(IPC_TR_DL_DID_DROP_FOR_NETIF_INFO_LOCK_FAIL, "[IPCORE] pdn_id(%d) ip_id(%d) drops type(%d) [did_head(0x%X), did_tail(0x%X)] downlink packets : netif detach found during getting netif information!")
    ...
    TRC_MSG(IPC_TR_DL_DID_DROP_FOR_NETIF_DETACH, "[IPCORE] pdn_id(%d) ip_id(%d) drops type(%d) [did_head(0x%X), did_tail(0x%X)] downlink packets for netif detached!")
    TRC_MSG(IPC_TR_DL_PENDING_DID_DROP_FOR_NETIF_DETACH, "[IPCORE] drops type(%d) Pending DID:[did_head(0x%X), did_tail(0x%X)] downlink packets for netif detached!")
    ...
    TRC_MSG(IPC_TR_DL_DID_DROP_FOR_INVALID_SESSION, "[IPCORE] pdn_id(%d) drops downlink packets [did_head(0x%X), did_tail(0x%X)] for invalid session!")
    TRC_MSG(IPC_TR_DL_PENDING_DID_DROP_FOR_INVALID_SESSION, "[IPCORE] netif(0x%X) drops downlink pending packets [did_head(0x%X), did_tail(0x%X)] for invalid session!")
    ...
    TRC_MSG(IPC_TR_NEW_FILTER_INVALID_PARAMS, "[IPCORE] ipc_new_filter_id(): failed with invalid parameters: rules(0x%X), callback_func(0x%X), module_id(0x%X)")
    TRC_MSG(IPC_TR_NEW_FILTER_UNAVAILABLE, "[IPCORE] ipc_new_filter_id(): failed with all filters are busy now!")
    TRC_MSG(IPC_TR_REGISTER_FILTER_VALIDATE_FAIL, "[IPCORE] ipc_register_filter_by_ilm(): filter rule validate fail: uplink?(%d)")
    ...
    TRC_MSG(IPC_TR_REGISTER_FILTER_NG, "[IPCORE] ipc_register_filter_by_ilm(): failed to create a new filter!")
    ...
    TRC_MSG(IPC_TR_DEREGISTER_FILTER_WITH_INVALID_ID, "[IPCORE] ipc_deregister_filter_by_ilm(): this filter invalid filter_id(%d)!")
    ...
    TRC_MSG(IPC_TR_REMOVE_DL_FILTER_RETRY, "[IPCORE] ipc_deregister_filter(): need retry remove filter_id(%d) ")
    ...
    TRC_MSG(IPC_TR_PACK_PKT_PUBLIC_FAILED, "[IPCORE] ipc_pack_pkt_public(): failed to pack packet : isGPD(%d), hdr(0x%X)!")
    TRC_MSG(IPC_TR_UL_PKT_PKT_PACK_FAILED, "[IPCORE] ipc_send_ul_pkt(): failed to pack uplink packet : isGPD(%d), hdr(0x%X)!")
    TRC_MSG(IPC_TR_UL_PKT_BY_PDN_PKT_PACK_FAILED, "[IPCORE] ipc_send_ul_pkt_by_pdn(): failed to pack uplink packet : isGPD(%d), hdr(0x%X)!")
    TRC_MSG(IPC_TR_UL_PKT_BY_PDN_SESSION_NOT_FOUND, "[IPCORE] ipc_send_ul_pkt_by_pdn(): destination sesssion for pdn(%d), ip_type(%d) is not found!")
    TRC_MSG(IPC_TR_UL_PKT_BY_NETIF_ID_PKT_PACK_FAILED, "[IPCORE] ipc_send_ul_pkt_by_netif_id(): failed to pack uplink packet : isGPD(%d), hdr(0x%X)!")
    TRC_MSG(IPC_TR_UL_PKT_BY_NETIF_ID_SESSION_NOT_FOUND, "[IPCORE] ipc_send_ul_pkt_by_netif_id(): destination sesssion for netif_id(%d), ip_type(%d) is not found!")
    TRC_MSG(IPC_TR_UL_PKT_BY_NETIF_ID_NETIF_NOT_FOUND, "[IPCORE] ipc_send_ul_pkt_by_netif_id(): source netif for netif_id(%d) is not found!")
    ...
    TRC_MSG(IPC_TR_DL_PKT_NETIF_DID_NOT_FOUND, "[IPCORE] ipc_send_dl_pkt_in_did(): destination network interface for ID(%d) is not found!")
    TRC_MSG(IPC_TR_DL_PKT_NETIF_DID_ALLOC_DID_NG, "[IPCORE] ipc_send_dl_pkt_in_did(): Allocating new DID FAILED: head_gpd(0x%x), tail_gpd(0x%x), netif_id(0x%x)!")
    ...
    TRC_MSG(IPC_TR_CHANGE_GPD_TYPE_ZERO_LENGTH_BD, "[IPCORE] ipc_gpd_change_gpd_type(): Found packet with ALL ZERO-length BD list during clarification : curr_gpd(0x%x), gpd length(%d)")
    TRC_MSG(IPC_TR_CHANGE_GPD_TYPE_ALLOC_GPD_NG, "[IPCORE] ipc_gpd_change_gpd_type(): Allocate new GPD for different type is FAILED: gpd_type(%d), p_gpd(0x%x)")
    ...
    TRC_MSG(IPC_TR_SI_UNITE_ALLOC_GPD_NG, "[IPCORE] ipc_si_unite_to_gpd(): Allocate new GPD for uniting is FAILED: uplink(%d), did(0x%x), curr_si_idx(%d), pkt_len(%d)")
    ...
    TRC_MSG(IPC_TR_DID_SHIFT_OFFSET_FAILED, "[IPCORE] ipc_shift_did_content_ptr(): DID/SIT is too short to get offset! did(0x%x) base_si_idx(%d) curr_si_idx(%d) curr_si_len(%d) remaining_offset(%d) base_addr_p(0x%x) offset(%d)")
    ...
    TRC_MSG(IPC_TR_DID_CONTENT_LENGTH_TOO_SHORT, "[IPCORE] ipc_get_continuous_content_did(): DID/SIT is too short to shift offset! did(0x%x) base_si_idx(%d) curr_si_idx(%d) base_addr_p(0x%x) offset(%d) length(%d)")
    TRC_MSG(IPC_TR_DID_CONTENT_LENGTH_TOO_SHORT_TO_COPY, "[IPCORE] ipc_get_continuous_content_did(): DID/SIT is too short to copy specific continuous content! did(0x%x) base_si_idx(%d) curr_si_idx(%d) curr_si_len(%d) remaining_length(%d) base_addr_p(0x%x) offset(%d) length(%d)")
    TRC_MSG(IPC_TR_GET_INFO_FAILED, "[IPCORE] ipc_get_packet_info(): fail_reason(%Mipc_packet_info_parser_error_code), ip_packet(0x%x), offset(%d), gpd(0x%x), curr_bd(0x%x), length(%d)")
    TRC_MSG(IPC_TR_GET_INFO_SHIFT_FAILED, "[IPCORE] ipc_get_packet_info(): fail_reason(%Mipc_packet_info_parser_error_code), gpd(0x%x) base_bd(0x%x) ip_packet(0x%x) offset(%d) next_header(0x%x) curr_bd(0x%x)")
    TRC_MSG(IPC_TR_GET_INFO_SPD_FAILED, "[IPCORE] ipc_get_packet_info_spd(): fail_reason(%Mipc_packet_info_parser_error_code),ip_packet(0x%x), data_len(%d), packet_len(%d)")
    TRC_MSG(IPC_TR_GET_INFO_DID_FAILED, "[IPCORE] ipc_get_packet_info_did(): fail_reason(%Mipc_packet_info_parser_error_code): ip_packet(0x%x), offset(%d), did(0x%x), base_si_idx(0x%x), length(%d)")
    TRC_MSG(IPC_TR_GET_INFO_DID_SHIFT_FAILED, "[IPCORE] ipc_get_packet_info_did(): fail_reason(%Mipc_packet_info_parser_error_code) did(0x%x) base_si_idx(%d) ip_packet(0x%x) offset(%x) next_header(0x%x) curr_si_idx(%d)")
    ...
    TRC_MSG(IPC_TR_META_DO_FILTER_ALLOC_GPD_NG, "[IPCORE] ipc_meta_do_filter(): Allocating new GPD for the META filtered out packet is FAILED: uplink(%d), META(0x%x)")
    TRC_MSG(IPC_TR_LAN_NETIF_BIND_INVALID_NETIF, "[IPCORE] ipc_bind_lan_netif(): netifs not found for netif_1(0x%x)/id(0x%x) && netif_2(0x%x)/id(0x%x)!")
    TRC_MSG(IPC_TR_LAN_NETIF_UNBIND_INVALID_NETIF, "[IPCORE] ipc_unbind_lan_netif(): netifs not found for netif_1(0x%x)/id(0x%x) && netif_2(0x%x)/id(0x%x)!")
    TRC_MSG(IPC_TR_DID_GET_PKT_LENGTH_FAILED, "[IPCORE] ipc_did_do_filter(): Get first 6B continuous content failed: ip_packet(0x%x), did(0x%x), curr_idx(%d)")
    TRC_MSG(IPC_TR_COPY_GPD_TO_DID_ZERO_LENGTH_GPD, "[IPCORE] ipc_copy_gpd_to_did(): Zero length GPD: curr_gpd(0x%x)!")
    TRC_MSG(IPC_TR_COPY_GPD_TO_DID_ZERO_ALLOC_PRB_NG, "[IPCORE] ipc_copy_gpd_to_did(): Allocating new PRB FAILED: curr_gpd(0x%x), tail_gpd(0x%x)!")
    TRC_MSG(IPC_TR_COPY_GPD_TO_DID_GPD_LENGTH_NG, "[IPCORE] ipc_copy_gpd_to_did(): GPD/BD length is not expected: curr_gpd(0x%x)!")
    TRC_MSG(IPC_TR_FIND_PDN_BY_NETIF_SESSION_RLOCK_FAILED, "[IPCORE] ipc_find_pdn_id_by_netif_id(): session RLOCK is FAILED: netif_id(0x%x), ip_type(%d)!")
    TRC_MSG(IPC_TR_FIND_PDN_BY_NETIF_NETIF_RLOCK_FAILED, "[IPCORE] ipc_find_pdn_id_by_netif_id(): netif RLOCK is FAILED: netif_id(0x%x), ip_type(%d)!")
    TRC_MSG(IPC_TR_IS_NETIF_BIND_INVALID_PARAM, "[IPCORE] ipc_is_netif_bind(): invalid input parameter netif_id(0x%x)!")
    TRC_MSG(IPC_TR_FILTER_MATCHED_CLONED, "[IPCORE] ipc_pkt_do_one_filter(): Filter matched cloned !!!")
    TRC_MSG(IPC_TR_FILTER_MATCHED_CLONED_DEFAULT_PATH, "[IPCORE] ipc_did_do_filter(): Filter matched cloned case, it didn't set ignore bit, keep default data path")
    TRC_MSG(IPC_TR_DL_DID_B4_DROP_GPD_ALLOC_NG, "[IPCORE] %s():%d: GPD allocation failed in drop packet handler")
    TRC_MSG(IPC_TR_DL_DID_B4_DROP_GPD_ALLOC_NG_CNT, "[IPCORE] %s():%d: failed_cnt=%d: GPD allocation failed in drop packet handler")
    TRC_MSG(IPC_TR_DROP_HDLR_NG_PROTO, "[IPCORE] %s(): unknown protocol(0x%x) is not supported in drop packet handler")
    TRC_MSG(IPC_TR_DL_DID_B4_DROP_SEND_UL_GPD, "[IPCORE] %s(): detect TCP packet B4 drop, send response 1st GPD(0x%x) and 2nd GPD(0x%x)!")
    TRC_MSG(IPC_TR_DROP_HDLR_UNKNOWN_IPTYPE, "[IPCORE] %s(): unknown IP_TYPE is not supported in drop packet handler")
    TRC_MSG(IPC_TR_DROP_HDLR_PKT_INFO_NG, "[IPCORE] %s(): packet info parsing NG in drop packet handler")
    TRC_MSG(IPC_ON_DOWNLINK_RA_RPOXY, "[IPCORE] End of ipc_on_downlink_ra_proxy()")
    TRC_MSG(IPC_ON_DOWNLINK_RA_RPOXY_GPD, "[IPCORE] ipc_on_downlink_ra_proxy(): pdn_id = 0x%X, copy RA did to GPD 0x%x")
    TRC_MSG(IPC_TR_GET_PDN_ID_FAILED, "[IPCORE] %s(): get pdn by netif failed")
    TRC_MSG(IPC_TR_INVALID_ARGS, "[IPCORE] %s(): Invalid argument : input pointer was NULL")
    TRC_MSG(IPC_TR_SEND_RA_GPD_NETIF, "[IPCORE] %s(): Send RA GPD (0x%x) to netif_id (0x%x)")
    TRC_MSG(IPC_TR_SET_MOB_DATA_INFO, "[IPCORE] ipc_set_mobile_data_info(): sim_slot:[%d] mobile_data:[%d]")
    TRC_MSG(IPC_TR_SET_EDALLOW_DATA_INFO, "[IPCORE] ipc_set_data_allowed_info(): data_sim_slot_idx:[%d]")
    TRC_MSG(IPC_TR_NEED_RUN_TCP_RST, "[IPCORE] ipc_get_need_skip_tcp_rst(): is_skip:[%d]")
    ...
    TRC_MSG(PFM_TR_FIN_ACK_FILTER_RECEIVED_AP_STATUS, "[PFM] pfm_ap_status_parser(): Received AP status (%s)")
    TRC_MSG(PFM_TR_FIN_ACK_FILTER_RECEIVED_AP_INVALID_STATUS, "[PFM] pfm_ap_status_parser(): Invalid AP status")
    TRC_MSG(PFM_TR_FIN_ACK_FILTER_RECEIVED_AP_SUSPEND_CMD, "[PFM] pfm_ap_suspend_handler(): Received AP command (%u)")
    TRC_MSG(PFM_TR_FIN_ACK_FILTER_FIN_ACK_FILTER_REQ, "[PFM] pfm_ap_fin_ack_reduction_handler(): Send PFM Register ILM with set id (%d)")
    TRC_MSG(PFM_TR_FIN_ACK_FILTER_ALLOCATE_FAILED, "[PFM] pfm_ap_fin_ack_reduction_handler(): Allocate local para failed")
    TRC_MSG(PFM_TR_FIN_ACK_FILTER_SEND_ILM_FAILED, "[PFM] pfm_ap_fin_ack_reduction_handler(): Send ILM failed")
    TRC_MSG(PFM_TR_FIN_ACK_FILTER_REGISTER_FILTER_ID_V4, "[PFM] pfm_fin_ack_filter_register_parser(): Registered fin ack v4 filter with filter id (%d)")
    TRC_MSG(PFM_TR_FIN_ACK_FILTER_REGISTER_FILTER_ID_V6, "[PFM] pfm_fin_ack_filter_register_parser(): Registered fin ack v6 filter with filter id (%d)")
    TRC_MSG(PFM_TR_FIN_ACK_FILTER_REGISTER_FILTER_FAILED, "[PFM] pfm_fin_ack_filter_register_parser(): Registered filter failed")
    TRC_MSG(PFM_TR_FIN_ACK_FILTER_DEREGISTER_FILTER, "[PFM] pfm_fin_ack_filter_deregister_callback(): Deregistered fin ack v4 filter id (%d), v6 filter id (%d)")
    TRC_MSG(PFM_TR_FIN_ACK_FILTER_REPLY_RST, "[PFM] pfm_fin_ack_filter_cbk(): Replay TCP RST GPD(0x%x), src_port(%d)")
    TRC_MSG(PFM_TR_FIN_ACK_FILTER_NO_ACTION_V4, "[PFM] pfm_fin_ack_filter_register_parser(): Already registered v4 filter (%d)")
    TRC_MSG(PFM_TR_FIN_ACK_FILTER_NO_ACTION_V6, "[PFM] pfm_fin_ack_filter_register_parser(): Already registered v6 filter (%d)")
