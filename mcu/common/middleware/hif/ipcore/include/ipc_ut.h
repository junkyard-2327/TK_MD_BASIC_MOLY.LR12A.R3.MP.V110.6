...
typedef enum {
    ...
    extern kal_bool ipc_ut_mdt_is_activated_g;
    ...
    #ifdef __MD_DIRECT_TETHERING_SUPPORT__
        #define mdt_check_route ipc_ut_mdt_check_route
        #define mdt_update_global_alert_data_usage(...)
        #define mdt_update_iquota_data_usage(...)
        #define mdt_id_to_netif_id(...) 0
        #define mdt_is_activated ipc_ut_mdt_is_activated_g
    #endif
