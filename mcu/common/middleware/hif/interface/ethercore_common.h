 ...
 *          Running Level: TASK
 *  @param  instance  device instance obtained while attach
 *  @param  start_idx  device instance obtained while attach
 *  @param  ior io request list to be indicated
 */
void ethc_rb_rx_complete(ethc_device_instance_t* instance, kal_uint16 start_idx, kal_uint16 end_idx, kal_uint8 queue_no);
