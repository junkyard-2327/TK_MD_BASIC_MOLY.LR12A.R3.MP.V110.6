 ...
 ****************************************************************************/
	...
	TRC_MSG(SST_RUNNING_TASK, "while processing TASK %c%c%c%c%c%c%c%c")
     TRC_MSG(SST_RUNNING_TASK_AT_VPE, "Task %s currently running at vpe %d")
	TRC_MSG(SST_RUNNING_HISR, "while processing HISR %c%c%c%c%c%c%c%c")
	TRC_MSG(SST_RUNNING_LISR, "while processing LISR IRQ%d")
	...
	TRC_MSG(SST_VICTIM_TITLE1, "Please note that other vpe(s) had simultaneous problems as well so please check following victims")
	TRC_MSG(SST_VICTIM_TITLE2, "to see if they affected to crashed vpe:")
	TRC_MSG(SST_VICTIM_VPE_NUMBER, "vpe%d")
	...
	TRC_MSG(SST_PHASE3_OWNER_FILE, "Please contact people in-charge of file %s to resolve the problem!")
	TRC_MSG(SST_PHASE3_OWNER_LR, "Please contact people in-charge of caller address 0x%08X to resolve the problem!")
    TRC_MSG(SST_PHASE3_OWNER_PC, "Please contact people in-charge of code at 0x%08X to resolve the problem! (you can use CaDeFa to find owner)")
	TRC_MSG(SST_PHASE3_OWNER_TASK, "Please contact people in-charge of task %c%c%c%c%c%c%c%c to resolve the problem!")
	TRC_MSG(SST_PHASE3_OWNER_HISR, "Please contact people in-charge of hisr %s to resolve the problem!")
	TRC_MSG(SST_PHASE3_OWNER_IRQ, "Please contact people in-charge of IRQ%d to resolve the problem!")
