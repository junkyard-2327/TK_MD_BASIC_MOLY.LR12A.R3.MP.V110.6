...
kal_status MD1_DSP_kal_cc_take_spinlock(void* cc_spinlock_p, kal_wait_mode wait_mode);
 ...
 *  boot_mode_type
 ******************************************************************************/
INLINE_MODIFIER INLINE void kal_set_boot_mode(boot_mode_type boot_mode)
{
    extern boot_mode_type system_boot_mode;
...
*  of NUv3 SUSPEND states (e.g. NU_QUEUE_SUSPEND) or the whole operation will
*  fail.
* PARAMETERS
...
kal_bool kal_runtime_group_affinity_set(kal_task_group_id group_id, kal_affinity_group affinity);
 ...
 * 
 ******************************************************************************/
kal_status kal_get_task_affinity_by_moduleID(module_type mod, kal_affinity_group* returnAffinity);
/* DOM_NOT_FOR_SDK-END */
 ...
 *  kal_give_spinlock
 ******************************************************************************/
kal_status kal_take_spinlock(kal_spinlockid ext_spinlock_id_ptr, kal_wait_mode wait_mode);
/*******************************************************************************
 * <GROUP Synchronous>
 *
 * FUNCTION
...
extern void *kal_afm_internal_alloc(KAL_AFM_ID afm_id, kal_uint32 size, kal_uint32 *actual_size, const kal_char *filename, kal_uint32 line);
/*******************************************************************************
 * <GROUP Functions>
 *
 * FUNCTION
...
extern void *kal_afm_internal_alloc_cacheable(KAL_AFM_ID adm_id, kal_uint32 size, kal_uint32 *actual_size, const kal_char *filename, kal_uint32 line);
#if defined(__MTK_TARGET__) && (defined(__ARM9_MMU__) || defined(__DYNAMIC_SWITCH_CACHEABILITY__))
...
#if defined(DEBUG_KAL) && defined(DEBUG_BUF2)
extern void kal_set_sensitive_buff_ext(void * buff_ptr);
/*******************************************************************************
 * <GROUP Functions>
 *
 * FUNCTION
...
#else
#define kal_set_sensitive_buff(ptr)
#endif
/* DOM-NOT_FOR_SDK-END */
/*******************************************************************************
...
extern event_scheduler *evshed_create(kal_char *evshed_name, module_type module_id,
                                      kal_uint32 allowed_time_shift, kal_uint32 allowed_time_shift_sleep_mode);
