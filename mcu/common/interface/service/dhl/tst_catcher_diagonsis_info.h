...
typedef enum
{
    ...
    CATCHER_EXC_OWNER_CCCI_YuHsiang_Peng = CATCHER_EXC_MODULES_UARTUSB, //owners should be up-to-date
#else
    CATCHER_EXC_OWNER_CCCI_YuHsiang_Peng = CATCHER_EXC_MODULES_UARTUSB, //owners should be up-to-date
#endif
#else
    ...
    CATCHER_EXC_OWNER_DHL_YuHsiang_Peng = CATCHER_EXC_MODULES_DHL, //owners should be up-to-date
}
...
typedef enum
{
    ...
    //this table is updated by yu-hsiang peng 2017_01_02 for 93 series
