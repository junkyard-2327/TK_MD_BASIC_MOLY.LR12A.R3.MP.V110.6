 ...
 * $Log$
 *
 * 05 24 2019 viney.kaushik
 * [MOLY00408655] [Tinno][U303AF][TF]SIMLOCK ?????key - true random number API
 * 	
 * 	add new RPC to get random number from AP.
 *
...
X_CCCI_RPC_CONF(IPC_RPC_TRNG_GET_RANDOM_NUMBER  ,   0x4012)
