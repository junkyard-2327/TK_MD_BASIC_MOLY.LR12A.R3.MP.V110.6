...
#define DRV_SIM_6292_SERIES
#endif

#if defined(MT6763) || defined(MT6739) || defined(MT6771) || defined(MT6765) || defined(MT6761) || defined(MT6768)
#define DRV_SIM_6293_SERIES
#endif

#if defined(MT6295M) || defined(MT3967) 
#define DRV_SIM_6295_SERIES
#endif

#if defined(DRV_SIM_6290_SERIES) || defined(DRV_SIM_6291_SERIES) || defined(DRV_SIM_6292_SERIES) || defined(DRV_SIM_6293_SERIES) || defined(DRV_SIM_6295_SERIES)
#define DRV_SIM_LTE_SERIES
#endif
...
#if defined(MT6276) || defined(MT6256) || defined(DRV_SIM_6575_SERIES) || defined(MT6255) || defined(MT6250) || defined(DRV_SIM_6256_SERIES) || defined(DRV_SIM_LTE_SERIES)
...
#if defined(DRV_SIM_6293_SERIES)
#define SIM_DRV_USE_MDGPIO_I2C
#endif
#if defined(MT6763)|| defined(MT6761)
#define __SIM_DRV_CO_LOAD_MT6306__
#endif
#endif
...
#if !defined(MT6290) && defined(DRV_SIM_LTE_SERIES)
#define __SIM_HOT_PLUG_SINGLE_MD_QUERY_STR__
#endif
...
#define SIM_LOCK_SRCCLK_FOR_NONE_STOP_CLK_CARD
 #endif // #if defined(DRV_SIM_LTE_SERIES)
...
#if !defined(__FPGA__) && (defined(MT6755) || defined(ELBRUS) || defined(MT6799) || defined(MT6759) || defined(MT6739) || defined(MT6765))|| defined(MT6771) || defined(MT6761) || defined(MT6768)
#define	__DRV_SIM_LP_MODE__	1
#endif

#if defined(MT6799) || defined(MT6759) || defined(DRV_SIM_6293_SERIES) || defined(DRV_SIM_6295_SERIES)
#define  __SIM_DRV_SET_OE_BEFOR_PWRON__

//#define __SIM_ACTIVATION_V2__ 
#define __SIM_SAME_GPIO_MODE__
#endif

#if defined(MT6759) || defined(MT6763) || defined(MT6771) || defined(__SIM_DRV_RETRY_3V_WHEN_SIM_RECOVERY__)
#define SIM_DRV_RETRY_3V_WHEN_CMD_FAIL
#endif

#if defined(MT6799)
#define SIM_DRV_RETRY_SPECIAL_MODE_WHEN_CMD_FAIL
#endif

#if defined(DRV_SIM_6292_SERIES) || defined(DRV_SIM_6293_SERIES) || defined(DRV_SIM_6295_SERIES)
#define SIM_DRV_4_33MHZ_SCLK
#endif

#if defined(DRV_SIM_6295_SERIES)
#define SIM_DRV_3_71MHZ_SCLK
#endif

#define SIM_DRV_HISR_INIT_CENTRALIZATION

#if defined(__SIM_EXTENDED_APDU__)
#define SIM_DRV_EXTENDED_APDU
#endif
