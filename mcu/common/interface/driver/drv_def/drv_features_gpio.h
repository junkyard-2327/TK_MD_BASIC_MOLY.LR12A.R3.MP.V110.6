...
/**************** GPIO Feature Option******************/
  ...
  #define DRV_GPIO_6280_SPECIAL_SET_REG
   ...
   #define DRV_GPIO_FULL_FUNC
  #elif defined(DRV_GPIO_MT6763_SERIES)
   #define DRV_GPIO_REG_AS_MT6763
   #define DRV_GPIO_FULL_FUNC
  #elif defined(DRV_GPIO_MT6739_SERIES)
   #define DRV_GPIO_REG_AS_MT6739
   #define DRV_GPIO_FULL_FUNC
  #elif defined(DRV_GPIO_MT6771_SERIES)
   #define DRV_GPIO_REG_AS_MT6771
   #define DRV_GPIO_FULL_FUNC
  #elif defined(DRV_GPIO_MT6765_SERIES)
   #define DRV_GPIO_REG_AS_MT6765
   #define DRV_GPIO_FULL_FUNC
  #elif defined(DRV_GPIO_MT6761_SERIES)
   #define DRV_GPIO_REG_AS_MT6761
   #define DRV_GPIO_FULL_FUNC
  #elif defined(DRV_GPIO_MT6768_SERIES)
   #define DRV_GPIO_REG_AS_MT6768
   #define DRV_GPIO_FULL_FUNC
  #else
   #define DRV_GPIO_OFF 
  #endif
