...
#elif defined(TK6291) || defined(MT6755) || defined(MT6797)
    #define DRV_WriteReg32_NPW_RB(write_addr, data, read_addr)		     \
    do{ 															     \
...
#elif defined(ELBRUS) || defined(MT6763) || defined(MT6739) || defined(MT6771) ||  defined(MT6765) || defined(MT6295M) ||  defined(MT6761) ||  defined(MT6768)
