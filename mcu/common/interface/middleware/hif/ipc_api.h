...
typedef struct _ipc_io_request_t {
    ...
    /**< reserved[0] is used by IPCore high priority queue for different packet source [UL]
     *   and reserved[0]/[1] used by Fast CCCI Header as number of GPD in IOR list. [DL] */
    kal_uint8                   reserved[2];
} ipc_io_request_t;
 ...
 */
void
ipc_frag_refilter(kal_uint8 ip_type, ipc_frag_refilter_info_t *info, qbm_gpd *p_head, qbm_gpd *p_tail);
 ...
 */
void
ipc_frag_send_pkt(kal_uint8 ip_type, ipc_frag_refilter_info_t *info, qbm_gpd *p_head, qbm_gpd *p_tail);
