...
const kal_uint32 devdrv_dump_regions[] = {
  #if defined(MT6290)||defined(MT6595)||defined(TK6291)||defined(MT6755)||defined(MT6797)||defined(ELBRUS)||defined(MT6763)||defined(MT6739)||defined(MT6771)||defined(MT6765)||defined(MT6295M)||defined(MT6761)||defined(MT6768) 
...
#if !defined(__DUOS_HAS_VOLTECORE__)
...
//#endif
   ...
   INT_Trace_Enter(INIT_DRV2_SOE, 1);
   SOE_Drv_Init();
   INT_Trace_Exit(INIT_DRV2_SOE, 1);
