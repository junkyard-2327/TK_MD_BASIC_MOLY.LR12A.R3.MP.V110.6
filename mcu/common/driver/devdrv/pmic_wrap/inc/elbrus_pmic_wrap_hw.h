 ...
 * Description:
 * ------------
 *	This is elbrus pmic wrapper h/w register
 *
 * Author:
 * -------
 * -------
...
#ifndef __ELBRUS_PMIC_WRAP_HW_H__
#define __ELBRUS_PMIC_WRAP_HW_H__


//INFRASYS_TOP_MODULE			0x10210000
//INFRA_AO_INFRASYS_CONFIG_REGS	0x10000000
//INFRA_AO_PMIC_WRAP			0x10010000

#if !defined(__FPGA__)
#include "reg_base.h"
//Ref: reg_base_ELBRUS.h
//#define BASE_MADDR_APMCU_MISC (0xC0000000)
#define TOPCKGEN_BASE           	(BASE_MADDR_APMCU_MISC + 0x210000)
#define INFRACFG_AO_BASE        	(BASE_MADDR_APMCU_MISC + 0x0)
#define PMIC_WRAP_BASE				(BASE_MADDR_APMCU_MISC + 0x10000)	
#else
#define TOPCKGEN_BASE            		(0x10210000)
#define INFRACFG_AO_BASE         		(0x10000000)
#define PMIC_WRAP_BASE 			 		(0x10010000)
#endif		
...
#define PMIC_WRAP_CSLEXT_WRITE          ((PMIC_WRAP_BASE+0x1C))
#define PMIC_WRAP_CSLEXT_READ           ((PMIC_WRAP_BASE+0x20))
#define PMIC_WRAP_STAUPD_CTRL           ((PMIC_WRAP_BASE+0x24))
#define PMIC_WRAP_STAUPD_GRPEN          ((PMIC_WRAP_BASE+0x28))
#define PMIC_WRAP_EINT_STA0_ADR         ((PMIC_WRAP_BASE+0x2C))
#define PMIC_WRAP_EINT_STA1_ADR         ((PMIC_WRAP_BASE+0x30))
#define PMIC_WRAP_EINT_STA              ((PMIC_WRAP_BASE+0x34))
#define PMIC_WRAP_EINT_CLR              ((PMIC_WRAP_BASE+0x38))
#define PMIC_WRAP_STAUPD_MAN_TRIG       ((PMIC_WRAP_BASE+0x3C))
#define PMIC_WRAP_STAUPD_STA            ((PMIC_WRAP_BASE+0x40))
...
#define PMIC_WRAP_WACS3_EN              ((PMIC_WRAP_BASE+0xA8))
#define PMIC_WRAP_INIT_DONE3            ((PMIC_WRAP_BASE+0xAC))
#define PMIC_WRAP_WACS3_CMD             ((PMIC_WRAP_BASE+0xB0))
#define PMIC_WRAP_WACS3_RDATA           ((PMIC_WRAP_BASE+0xB4))
#define PMIC_WRAP_WACS3_VLDCLR          ((PMIC_WRAP_BASE+0xB8))
...
#define PMIC_WRAP_TIMER_EN              ((PMIC_WRAP_BASE+0xF0))
#define PMIC_WRAP_TIMER_STA             ((PMIC_WRAP_BASE+0xF4))
#define PMIC_WRAP_WDT_UNIT              ((PMIC_WRAP_BASE+0xF8))
#define PMIC_WRAP_WDT_SRC_EN            ((PMIC_WRAP_BASE+0xFC))
#define PMIC_WRAP_WDT_FLG               ((PMIC_WRAP_BASE+0x100))
...
#define PMIC_WRAP_SPMINF_STA            ((PMIC_WRAP_BASE+0x1AC))
#define PMIC_WRAP_CIPHER_KEY_SEL        ((PMIC_WRAP_BASE+0x1B0))
#define PMIC_WRAP_CIPHER_IV_SEL         ((PMIC_WRAP_BASE+0x1B4))
#define PMIC_WRAP_CIPHER_EN             ((PMIC_WRAP_BASE+0x1B8))
#define PMIC_WRAP_CIPHER_RDY            ((PMIC_WRAP_BASE+0x1BC))
#define PMIC_WRAP_CIPHER_MODE           ((PMIC_WRAP_BASE+0x1C0))
#define PMIC_WRAP_CIPHER_SWRST          ((PMIC_WRAP_BASE+0x1C4))
#define PMIC_WRAP_DCM_EN                ((PMIC_WRAP_BASE+0x1C8))
#define PMIC_WRAP_DCM_SPI_DBC_PRD       ((PMIC_WRAP_BASE+0x1CC))
#define PMIC_WRAP_DCM_DBC_PRD           ((PMIC_WRAP_BASE+0x1D0))
#define PMIC_WRAP_EXT_CK                ((PMIC_WRAP_BASE+0x1D4))
#define PMIC_WRAP_ADC_CMD_ADDR          ((PMIC_WRAP_BASE+0x1D8))
#define PMIC_WRAP_PWRAP_ADC_CMD         ((PMIC_WRAP_BASE+0x1DC))
#define PMIC_WRAP_ADC_RDATA_ADDR        ((PMIC_WRAP_BASE+0x1E0))
#define PMIC_WRAP_GPS_STA               ((PMIC_WRAP_BASE+0x1E4))
#define PMIC_WRAP_GPS_ADC_OPTIONS       ((PMIC_WRAP_BASE+0x1E8))
...
#define PMIC_WRAP_DEBUG_SW_DRIVER_0     ((PMIC_WRAP_BASE+0x340))
#define PMIC_WRAP_DEBUG_SW_DRIVER_1     ((PMIC_WRAP_BASE+0x344))
#define PMIC_WRAP_DEBUG_SW_DRIVER_2     ((PMIC_WRAP_BASE+0x348))
#define PMIC_WRAP_DEBUG_SW_DRIVER_3     ((PMIC_WRAP_BASE+0x34C))
#define PMIC_WRAP_DEBUG_SW_DRIVER_4     ((PMIC_WRAP_BASE+0x350))
#define PMIC_WRAP_DEBUG_SW_DRIVER_5     ((PMIC_WRAP_BASE+0x354))
#define PMIC_WRAP_BWC_OPTIONS           ((PMIC_WRAP_BASE+0x358))
#define PMIC_WRAP_RESERVED              ((PMIC_WRAP_BASE+0x35C))
...
[0]: MDINF"
*/
#define HARB_HPRIO_WACSP2P      (1 << 14) // (SCP SW) 
#define HARB_HPRIO_WACS2        (1 << 13) // (AP SW)
#define HARB_HPRIO_GPSINF       (1 << 12) 
#define HARB_HPRIO_STAUPD       (1 << 11)
#define HARB_HPRIO_MD_ADCINF    (1 << 10)
#define HARB_HPRIO_DCXO_NFCINF	(1 << 9)
#define HARB_HPRIO_DCXO_CONNINF	(1 << 8)
#define HARB_HPRIO_WACSMD32		(1 << 7)  // (MD32 SW)
#define HARB_HPRIO_WACS3        (1 << 6)  // (C2K SW)
#define HARB_HPRIO_DVFSINF      (1 << 5)  // (SPMINF)
#define HARB_HPRIO_WACS0        (1 << 4)  // (MD SW0)
#define HARB_HPRIO_WACS1        (1 << 3)  // (MD SW1)
...
#define OP_ODNID (0x1A)
 ...
 #endif // __ELBRUS_PMIC_WRAP_HW_H__                   
