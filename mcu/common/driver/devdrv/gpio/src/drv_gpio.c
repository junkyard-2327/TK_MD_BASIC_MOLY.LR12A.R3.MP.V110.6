 ...
 *
 * 12 27 2018 gang.lei
 * [MOLY00375311] [Talbot]Call for check-in  to LR12A.R3.MP.
 *
 * 01 23 2018 zhiqiang.yu
 * [MOLY00303776] [Merlot call for check-in][GPIO]Porting for Merlot
 * 	
 * 	.
 *
 * 01 23 2018 zhiqiang.yu
...
kal_int32 gpio_get_dir_value (gpio_pin_e gpio_pin)
{
	...
	return dir_val;
#elif defined(MT6755)||defined(MT6797)|| defined(ELBRUS) || defined(MT6763)||defined(MT6739)||defined(MT6771)|| defined(MT6765)|| defined(MT6761)|| defined(MT6768)
	unsigned long pos;
	unsigned long bit;
	unsigned long data;
...
#elif defined(MT6797) || defined(ELBRUS) || defined(MT6763)||defined(MT6739)||defined(MT6771)|| defined(MT6765)|| defined(MT6761)|| defined(MT6768)
