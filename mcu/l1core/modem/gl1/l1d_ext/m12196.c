...
/*MT6176*/    L1D_RF_Set_Mixedsys_2G_APC_Select( 0 );
/*MT6176*/    L1D_RF_Info_Trace( 12196, 0, 0);
...
#if IS_RF_MT6179
/*MT6179*/
/*MT6179*/ #include "intrCtrl.h"
/*MT6179*/
/*MT6179*/ /***********************************************************************************/
/*MT6179*/ /*  Local Variables                                                                */
/*MT6179*/ /***********************************************************************************/
/*MT6179*/ 
/*MT6179*/
/*MT6179*/ extern void L1D_DM_Power_Control_Trace( char is_2g, char is_3g );
/*MT6179*/ #if IS_RF_CENTRAL_CONTROL_ENABLE
/*MT6179*/ void  L1D_RF_PowerOn( void )
/*MT6179*/ {
/*MT6179*/    if( l1d_rf.is_init || l1d_rf2.is_wakeup )
/*MT6179*/    {
/*MT6179*/       /* RF Power On by MML1 RF central control */
/*MT6179*/       MML1_RF_POWER_ON( l1d_rf2.is_wakeup, MML1_RF_2G );
/*MT6179*/       /* Set the 2G force PWM mode */
/*MT6179*/       L1D_PMIC_ADPT2_PWM_ENABLE( 1 );  // to be checked PMIC control
/*MT6179*/    }
/*MT6179*/
/*MT6179*/    if( !l1d_rf2.is_wakeup )
/*MT6179*/    {  L1D_RF_Set_FixAFC_Status();
/*MT6179*/    }
/*MT6179*/
/*MT6179*/ }
/*MT6179*/
/*MT6179*/ void  L1D_RF_PowerOff( void )
/*MT6179*/ {  // Sleep to Phone Standby
/*MT6179*/    /* RF Power Off by RF central control, SW need not send any BSI CW */
/*MT6179*/
/*MT6179*/    extern void L1D_RF_Info_Trace( unsigned short idx, long v1, long v2 );
/*MT6179*/    L1D_RF_Set_Mixedsys_2G_APC_Select( 0 );
/*MT6179*/    L1D_RF_Info_Trace( 12196, 0, 0);
/*MT6179*/    /* Clear the 2G force PWM mode */
/*MT6179*/    L1D_PMIC_ADPT2_PWM_ENABLE( 0 );
/*MT6179*/    MML1_RF_POWER_OFF( MML1_RF_2G );
/*MT6179*/
/*MT6179*/ #if IS_RF_TOOL_CUSTOMIZATION_SUPPORT_V2 && IS_2G_DRDI_SUPPORT
/*MT6179*/    L1D_CustomDynamicDebug();
/*MT6179*/ #endif
/*MT6179*/ }
/*MT6179*/
/*MT6179*/ void  L1D_RF_WindowOn( void )
/*MT6179*/ {
/*MT6179*/ }
/*MT6179*/
/*MT6179*/ void  L1D_RF_WindowOff( void )
/*MT6179*/ {
/*MT6179*/ }
/*MT6179*/
/*MT6179*/
...
#if IS_RF_MT6177L
/*MT6177L*/
/*MT6177L*/ #include "intrCtrl.h"
/*MT6177L*/
/*MT6177L*/ /***********************************************************************************/
/*MT6177L*/ /*  Local Variables                                                                */
/*MT6177L*/ /***********************************************************************************/
/*MT6177L*/ 
/*MT6177L*/
/*MT6177L*/ extern void L1D_DM_Power_Control_Trace( char is_2g, char is_3g );
/*MT6177L*/ #if IS_RF_CENTRAL_CONTROL_ENABLE
/*MT6177L*/ void  L1D_RF_PowerOn( void )
/*MT6177L*/ {
/*MT6177L*/ 
/*MT6177L*/    if( l1d_rf.is_init || l1d_rf2.is_wakeup )
/*MT6177L*/    {
/*MT6177L*/       /* RF Power On by MML1 RF central control */
/*MT6177L*/       MML1_RF_POWER_ON( l1d_rf2.is_wakeup, MML1_RF_2G );
/*MT6177L*/       
/*MT6177L*/       /* BSI BPI modules init are taken care by MMRF*/
/*MT6177L*/       /* Set bias in MMRF BSI/BPI moudle */
/*MT6177L*/       MMRF_SET_BSIBIAS_GSM(0);
/*MT6177L*/       RF_SET_FLAG( l1d_rf.mmrf_init_flags, MMRF_BSI_INIT_BIAS );
/*MT6177L*/       MMRF_SET_BPIBIAS_GSM(0);
/*MT6177L*/       RF_SET_FLAG( l1d_rf.mmrf_init_flags, MMRF_BPI_INIT_BIAS );
/*MT6177L*/
/*MT6177L*/       /* Set the 2G force PWM mode */
/*MT6177L*/       L1D_PMIC_ADPT2_PWM_ENABLE( 1 );  // to be checked PMIC control
/*MT6177L*/    }
/*MT6177L*/
/*MT6177L*/    if( !l1d_rf2.is_wakeup )
/*MT6177L*/    {  L1D_RF_Set_FixAFC_Status();
/*MT6177L*/    }
/*MT6177L*/
/*MT6177L*/ }
/*MT6177L*/
/*MT6177L*/ void  L1D_RF_PowerOff( void )
/*MT6177L*/ {  // Sleep to Phone Standby
/*MT6177L*/    /* RF Power Off by RF central control, SW need not send any BSI CW */
/*MT6177L*/
/*MT6177L*/    extern void L1D_RF_Info_Trace( unsigned short idx, long v1, long v2 );
/*MT6177L*/    L1D_RF_Set_Mixedsys_2G_APC_Select( 0 );
/*MT6177L*/    L1D_RF_Info_Trace( 12196, 0, 0);
/*MT6177L*/    /* Clear the 2G force PWM mode */
/*MT6177L*/    L1D_PMIC_ADPT2_PWM_ENABLE( 0 );
/*MT6177L*/    
/*MT6177L*/    MML1_RF_POWER_OFF( MML1_RF_2G );
/*MT6177L*/    RF_CLR_FLAG( l1d_rf.mmrf_init_flags, MMRF_BSI_INIT_BIAS );
/*MT6177L*/    RF_CLR_FLAG( l1d_rf.mmrf_init_flags, MMRF_BPI_INIT_BIAS );   
/*MT6177L*/
/*MT6177L*/ #if IS_RF_TOOL_CUSTOMIZATION_SUPPORT_V2 && IS_2G_DRDI_SUPPORT
/*MT6177L*/    L1D_CustomDynamicDebug();
/*MT6177L*/ #endif
/*MT6177L*/ }
/*MT6177L*/
/*MT6177L*/ void  L1D_RF_WindowOn( void )
/*MT6177L*/ {
/*MT6177L*/ }
/*MT6177L*/
/*MT6177L*/ void  L1D_RF_WindowOff( void )
/*MT6177L*/ {
/*MT6177L*/ }
/*MT6177L*/
/*MT6177L*/
...
#if IS_RF_MT6177M
/*MT6173*/
/*MT6173*/ #include "intrCtrl.h"
/*MT6173*/
/*MT6173*/ /***********************************************************************************/
/*MT6173*/ /*  Local Variables                                                                */
/*MT6173*/ /***********************************************************************************/
/*MT6173*/ 
/*MT6173*/
/*MT6173*/ extern void L1D_DM_Power_Control_Trace( char is_2g, char is_3g );
/*MT6173*/ #if IS_RF_CENTRAL_CONTROL_ENABLE
/*MT6173*/ void  L1D_RF_PowerOn( void )
/*MT6173*/ {
/*MT6173*/ 
/*MT6173*/    if( l1d_rf.is_init || l1d_rf2.is_wakeup )
/*MT6173*/    {
/*MT6173*/       /* RF Power On by MML1 RF central control */
/*MT6173*/       MML1_RF_POWER_ON( l1d_rf2.is_wakeup, MML1_RF_2G );
/*MT6173*/       
/*MT6173*/       /* BSI BPI modules init are taken care by MMRF*/
/*MT6173*/       /* Set bias in MMRF BSI/BPI moudle */
/*MT6173*/       MMRF_SET_BSIBIAS_GSM(0);
/*MT6173*/       RF_SET_FLAG( l1d_rf.mmrf_init_flags, MMRF_BSI_INIT_BIAS );
/*MT6173*/       MMRF_SET_BPIBIAS_GSM(0);
/*MT6173*/       RF_SET_FLAG( l1d_rf.mmrf_init_flags, MMRF_BPI_INIT_BIAS );
/*MT6173*/
/*MT6173*/       /* Set the 2G force PWM mode */
/*MT6173*/       L1D_PMIC_ADPT2_PWM_ENABLE( 1 );  // to be checked PMIC control
/*MT6173*/    }
/*MT6173*/
/*MT6173*/    if( !l1d_rf2.is_wakeup )
/*MT6173*/    {  L1D_RF_Set_FixAFC_Status();
/*MT6173*/    }
/*MT6173*/
/*MT6173*/ }
/*MT6173*/
/*MT6173*/ void  L1D_RF_PowerOff( void )
/*MT6173*/ {  // Sleep to Phone Standby
/*MT6173*/    /* RF Power Off by RF central control, SW need not send any BSI CW */
/*MT6173*/
/*MT6173*/    extern void L1D_RF_Info_Trace( unsigned short idx, long v1, long v2 );
/*MT6173*/    L1D_RF_Set_Mixedsys_2G_APC_Select( 0 );
/*MT6173*/    L1D_RF_Info_Trace( 12196, 0, 0);
/*MT6173*/    /* Clear the 2G force PWM mode */
/*MT6173*/    L1D_PMIC_ADPT2_PWM_ENABLE( 0 );
/*MT6173*/    
/*MT6173*/    MML1_RF_POWER_OFF( MML1_RF_2G );
/*MT6173*/    RF_CLR_FLAG( l1d_rf.mmrf_init_flags, MMRF_BSI_INIT_BIAS );
/*MT6173*/    RF_CLR_FLAG( l1d_rf.mmrf_init_flags, MMRF_BPI_INIT_BIAS );   
/*MT6173*/
/*MT6173*/ #if IS_RF_TOOL_CUSTOMIZATION_SUPPORT_V2 && IS_2G_DRDI_SUPPORT
/*MT6173*/    L1D_CustomDynamicDebug();
/*MT6173*/ #endif
/*MT6173*/ }
/*MT6173*/
/*MT6173*/ void  L1D_RF_WindowOn( void )
/*MT6173*/ {
/*MT6173*/ }
/*MT6173*/
/*MT6173*/ void  L1D_RF_WindowOff( void )
/*MT6173*/ {
/*MT6173*/ }
/*MT6173*/
/*MT6173*/
