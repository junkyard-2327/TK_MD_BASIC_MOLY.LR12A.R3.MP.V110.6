...
#ifndef _CL1D_POC_DATA_STRUCT_MT6177L_H_
#define _CL1D_POC_DATA_STRUCT_MT6177L_H_
/*****************************************************************************
* 
* FILE NAME   : cl1d_poc_data_struct_mt6177l.h
*
...
#define MMRFC_C2K_TX_DNL_PGA_A_SEQ_NUM           20  /*>  Calibration sequence for PGA-A */
#define MMRFC_C2K_TX_DNL_PGA_B_SEQ_NUM           (MMRFC_C2K_TX_DNL_PGA_B_GAIN_STEPS + MMRFC_C2K_TX_DNL_PGA_AUX_GAIN_STEPS - 1)  /*>  Calibration sequence for PGA-B and PGA-AUX */
...
#define MMRFC_C2K_TX_ROUTE_NUM_MAX                    (4)
...
/* under construction !*/
   ...
   /* TX DNL */
   kal_int16                   tx_dnl_lin_pga_a[MMRFC_C2K_TX_DNL_PGA_A_GAIN_STEPS]; /*> 21 gain diff, S7.8 */
   kal_int16                   tx_dnl_lin_pga_b[MMRFC_C2K_TX_DNL_PGA_B_GAIN_STEPS + MMRFC_C2K_TX_DNL_PGA_AUX_GAIN_STEPS]; /*> 17 gain diff, S7.8 */
