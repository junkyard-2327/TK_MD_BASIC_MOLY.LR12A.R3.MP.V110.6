...
#include "L1Trc.h"
	...
	#define MD_PTP_DBG_INFO(v1, v2, v3) do {\
		{\
			...
			TRC_OUTPUT_16_FIRST_WRAPPER_L1(0x0045,0x0045);\
	...
	#define MD_PTP_DBG_DUMP1(v1, v2, v3, v4) do {\
		{\
			...
			TRC_OUTPUT_16_FIRST_WRAPPER_L1(0x0145,0x0145);\
	...
	#define MD_PTP_DBG_DUMP2(v1, v2) do {\
		{\
			...
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v2,v2);\
			TRC_OUTPUT_16_FIRST_WRAPPER_L1(0x0245,0x0245);\
			TRC_OUTPUT_32_MID_WRAPPER_L1(cgen_local_v1,v1);\
	...
	#define MD_PTP_DBG_DUMP3(v1, v2, v3) do {\
		{\
			...
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v2,v2);\
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v3,v3);\
			TRC_OUTPUT_16_FIRST_WRAPPER_L1(0x0345,0x0345);\
			TRC_OUTPUT_32_MID_WRAPPER_L1(cgen_local_v1,v1);\
			TRC_OUTPUT_32_MID_WRAPPER_L1(cgen_local_v2,v2);\
	...
	#define MD_PTP_DBG_DUMP4(v1, v2) do {\
		{\
			...
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v2,v2);\
			TRC_OUTPUT_16_FIRST_WRAPPER_L1(0x0445,0x0445);\
			TRC_OUTPUT_32_MID_WRAPPER_L1(cgen_local_v1,v1);\
			TRC_OUTPUT_32_LAST_WRAPPER_L1(cgen_local_v2,v2);\
			TRC_END_FILL_L1();\
			TRC_END_FILTER_CHECK_L1(PTP_1_Trace_Filter, 1, 0x01);\
	...
	#define MD_PTP_DBG_DUMP5(v1, v2) do {\
		{\
			...
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v2,v2);\
			TRC_OUTPUT_16_FIRST_WRAPPER_L1(0x0545,0x0545);\
			TRC_OUTPUT_32_MID_WRAPPER_L1(cgen_local_v1,v1);\
			TRC_OUTPUT_32_LAST_WRAPPER_L1(cgen_local_v2,v2);\
			TRC_END_FILL_L1();\
			TRC_END_FILTER_CHECK_L1(PTP_1_Trace_Filter, 1, 0x01);\
	...
	#define MD_PTP_DBG_DUMP_Table(v1, v2) do {\
		{\
			...
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v2,v2);\
			TRC_OUTPUT_16_FIRST_WRAPPER_L1(0x0645,0x0645);\
			TRC_OUTPUT_8_MID_WRAPPER_L1(cgen_local_v1,v1);\
	...
	#define MD_PTP_DBG_MON(v1, v2, v3, v4, v5, v6, v7, v8) do {\
		{\
			...
			TRC_OUTPUT_16_FIRST_WRAPPER_L1(0x0745,0x0745);\
			TRC_OUTPUT_32_MID_WRAPPER_L1(cgen_local_v1,v1);\
			TRC_OUTPUT_8_MID_WRAPPER_L1(cgen_local_v2,v2);\
			TRC_OUTPUT_32_MID_WRAPPER_L1(cgen_local_v3,v3);\
