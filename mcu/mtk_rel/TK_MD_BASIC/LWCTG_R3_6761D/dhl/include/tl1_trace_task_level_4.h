...
#include "L1Trc.h"
	...
	#define AST_L1_Trace_Task_Context_Group4_TEST_MSG_1(v1) do {\
		{\
			TRC_START_FILTER_CHECK_L1(AST_L1_Trace_Task_Context_Group4_Trace_Filter, 1, 0x01);\
			...
			TRC_END_FILL_L1();\
			TRC_END_FILTER_CHECK_L1(AST_L1_Trace_Task_Context_Group4_Trace_Filter, 1, 0x01);\
		}\
	} while(0)
#else
	...
	#define AST_L1_Trace_Task_Context_Group4_TEST_MSG_2(v1) do {\
		{\
			TRC_START_FILTER_CHECK_L1(AST_L1_Trace_Task_Context_Group4_Trace_Filter, 1, 0x02);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v1,v1);\
			TRC_START_FILL_L1();\
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v1,v1);\
			...
			TRC_OUTPUT_8_LAST_WRAPPER_L1(cgen_local_v1,v1);\
			TRC_END_FILL_L1();\
			TRC_END_FILTER_CHECK_L1(AST_L1_Trace_Task_Context_Group4_Trace_Filter, 1, 0x02);\
		}\
	} while(0)
#else
...
#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group4_TAS_BY_RAT_PARAM(v1, v2, v3, v4, v5, v6, v7, v8, v9) do {\
		{\
			TRC_START_FILTER_CHECK_L1(AST_L1_Trace_Task_Context_Group4_Trace_Filter, 1, 0x02);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v2,v2);\
...
#else
	#define AST_L1_Trace_Task_Context_Group4_TAS_BY_RAT_PARAM(v1, v2, v3, v4, v5, v6, v7, v8, v9)
#endif

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define AST_L1_Trace_Task_Context_Group4_TAS_BY_BAND_PARAM(v1, v2, v3, v4, v5, v6, v7) do {\
		{\
			TRC_START_FILTER_CHECK_L1(AST_L1_Trace_Task_Context_Group4_Trace_Filter, 1, 0x02);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v2,v2);\
...
#else
	#define AST_L1_Trace_Task_Context_Group4_TAS_BY_BAND_PARAM(v1, v2, v3, v4, v5, v6, v7)
#endif
...
/*******************************/
EXTERN_TMD_FILTER(unsigned char, AST_L1_Trace_Task_Context_Group4_Trace_Filter, 5);
/*************************/
...
#define ChkL1ModFltr_AST_L1_Trace_Task_Context_Group4()	(FILTER_CHECK(AST_L1_Trace_Task_Context_Group4_Trace_Filter, 0, 1))
#define ChkL1ClsFltr_AST_L1_Trace_Task_Context_Group4_TEST_CLASS_1()	(ChkL1ModFltr_AST_L1_Trace_Task_Context_Group4()&&(FILTER_CHECK(AST_L1_Trace_Task_Context_Group4_Trace_Filter, 1, 0x01)))
#define ChkL1ClsFltr_AST_L1_Trace_Task_Context_Group4_TEST_CLASS_2()	(ChkL1ModFltr_AST_L1_Trace_Task_Context_Group4()&&(FILTER_CHECK(AST_L1_Trace_Task_Context_Group4_Trace_Filter, 1, 0x02)))
...
#define ChkL1MsgFltr_AST_L1_Trace_Task_Context_Group4_TAS_BY_RAT_PARAM()	ChkL1ClsFltr_AST_L1_Trace_Task_Context_Group4_TEST_CLASS_2()
#define ChkL1MsgFltr_AST_L1_Trace_Task_Context_Group4_TAS_BY_BAND_PARAM()	ChkL1ClsFltr_AST_L1_Trace_Task_Context_Group4_TEST_CLASS_2()
