...
#include "L1Trc.h"
	...
	#define L1_Trc_Multi_AFC_Update_Mode(v1, v2, v3, v4, v5) do {\
		{\
			TRC_START_FILTER_CHECK_L1(L1_AFC_Trace_Filter, 1, 0x01);\
			...
			TRC_END_FILL_L1();\
			TRC_END_FILTER_CHECK_L1(L1_AFC_Trace_Filter, 1, 0x01);\
		}\
	} while(0)
#else
	...
	#define L1_Trc_Multi_AFC_Query_Mode(v1, v2, v3, v4, v5, v6) do {\
		{\
			TRC_START_FILTER_CHECK_L1(L1_AFC_Trace_Filter, 1, 0x02);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v2,v2);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v3,v3);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v4,v4);\
			...
			TRC_END_FILL_L1();\
			TRC_END_FILTER_CHECK_L1(L1_AFC_Trace_Filter, 1, 0x02);\
		}\
	} while(0)
#else
	...
	#define L1_Trc_DLAFC_Dbg_Info(v1, v2, v3, v4, v5, v6, v7) do {\
		{\
			TRC_START_FILTER_CHECK_L1(L1_AFC_Trace_Filter, 1, 0x04);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v2,v2);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v3,v3);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v4,v4);\
			...
			TRC_END_FILL_L1();\
			TRC_END_FILTER_CHECK_L1(L1_AFC_Trace_Filter, 1, 0x04);\
		}\
	} while(0)
#else
	...
	#define L1_Trc_SGTDS_Dbg_Info(v1, v2, v3) do {\
		{\
			TRC_START_FILTER_CHECK_L1(L1_AFC_Trace_Filter, 1, 0x08);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v1,v1);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v2,v2);\
			TRC_PREPROCESS_DATA_SECTION1_L1(cgen_local_v3,v3);\
			TRC_START_FILL_L1();\
			...
			TRC_OUTPUT_16_LAST_WRAPPER_L1(cgen_local_v3,v3);\
			TRC_END_FILL_L1();\
			TRC_END_FILTER_CHECK_L1(L1_AFC_Trace_Filter, 1, 0x08);\
		}\
	} while(0)
#else
...
/*******************************/
EXTERN_TMD_FILTER(unsigned char, L1_AFC_Trace_Filter, 5);
/*************************/
...
#define ChkL1ModFltr_L1_AFC()	(FILTER_CHECK(L1_AFC_Trace_Filter, 0, 1))
#define ChkL1ClsFltr_L1_AFC_Multi_afc_dbg_H()	(ChkL1ModFltr_L1_AFC()&&(FILTER_CHECK(L1_AFC_Trace_Filter, 1, 0x01)))
#define ChkL1ClsFltr_L1_AFC_Multi_afc_dbg_L()	(ChkL1ModFltr_L1_AFC()&&(FILTER_CHECK(L1_AFC_Trace_Filter, 1, 0x02)))
#define ChkL1ClsFltr_L1_AFC_DLAFC_dbg_H()	(ChkL1ModFltr_L1_AFC()&&(FILTER_CHECK(L1_AFC_Trace_Filter, 1, 0x04)))
#define ChkL1ClsFltr_L1_AFC_SGTDS_dbg_H()	(ChkL1ModFltr_L1_AFC()&&(FILTER_CHECK(L1_AFC_Trace_Filter, 1, 0x08)))
