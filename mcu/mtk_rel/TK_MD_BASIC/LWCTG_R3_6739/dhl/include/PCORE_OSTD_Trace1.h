...
#include "L1Trc.h"
	...
	#define OSTD_TRC_DEBUG1(v1, v2, v3) do {\
		{\
			...
			TRC_OUTPUT_16_FIRST_WRAPPER_L1(0x0042,0x0042);\
	...
	#define OSTD_TRC_DEBUG2(v1, v2, v3) do {\
		{\
			...
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v2,v2);\
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v3,v3);\
			TRC_OUTPUT_16_FIRST_WRAPPER_L1(0x0142,0x0142);\
			TRC_OUTPUT_16_MID_WRAPPER_L1(cgen_local_v1,v1);\
			TRC_OUTPUT_32_MID_WRAPPER_L1(cgen_local_v2,v2);\
			TRC_OUTPUT_32_LAST_WRAPPER_L1(cgen_local_v3,v3);\
			TRC_END_FILL_L1();\
	...
	#define OSTD_SM_STATUS(v1, v2, v3, v4, v5, v6, v7, v8) do {\
		{\
			...
			TRC_OUTPUT_16_FIRST_WRAPPER_L1(0x0242,0x0242);\
			TRC_OUTPUT_16_MID_WRAPPER_L1(cgen_local_v1,v1);\
			TRC_OUTPUT_32_MID_WRAPPER_L1(cgen_local_v2,v2);\
	...
	#define OSTD_SM_STATUS2(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10) do {\
		{\
			...
			TRC_OUTPUT_16_FIRST_WRAPPER_L1(0x0342,0x0342);\
			TRC_OUTPUT_16_MID_WRAPPER_L1(cgen_local_v1,v1);\
			TRC_OUTPUT_32_MID_WRAPPER_L1(cgen_local_v2,v2);\
			TRC_OUTPUT_32_MID_WRAPPER_L1(cgen_local_v3,v3);\
			TRC_OUTPUT_32_MID_WRAPPER_L1(cgen_local_v4,v4);\
	...
	#define OSTD_SM_STATUS3(v1, v2, v3, v4, v5, v6, v7, v8, v9) do {\
		{\
			...
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v8,v8);\
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v9,v9);\
			TRC_OUTPUT_16_FIRST_WRAPPER_L1(0x0442,0x0442);\
	...
	#define OSTD_TRC_INF_SLEEP_TRG() do {\
		{\
			...
			TRC_START_FILL_L1();\
			TRC_OUTPUT_16_SINGLE_WRAPPER_L1(0x0542,0x0542);\
			TRC_END_FILL_L1();\
	...
	#define OSTD_TRC_INF_SLEEP_TIMER_CB(v1, v2, v3) do {\
		{\
			...
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v2,v2);\
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v3,v3);\
			TRC_OUTPUT_16_FIRST_WRAPPER_L1(0x0642,0x0642);\
	...
	#define OSTD_PATCH_STATUS(v1, v2, v3, v4, v5) do {\
		{\
			...
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v4,v4);\
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v5,v5);\
			TRC_OUTPUT_16_FIRST_WRAPPER_L1(0x0742,0x0742);\
			TRC_OUTPUT_16_MID_WRAPPER_L1(cgen_local_v1,v1);\
	...
	#define OSTD_TRC_DEBUGH3(v1, v2, v3) do {\
		{\
			...
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v2,v2);\
			TRC_PREPROCESS_DATA_SECTION2_L1(cgen_local_v3,v3);\
			TRC_OUTPUT_16_FIRST_WRAPPER_L1(0x0842,0x0842);\
			TRC_OUTPUT_16_MID_WRAPPER_L1(cgen_local_v1,v1);\
			TRC_OUTPUT_32_MID_WRAPPER_L1(cgen_local_v2,v2);\
			TRC_OUTPUT_32_LAST_WRAPPER_L1(cgen_local_v3,v3);\
			TRC_END_FILL_L1();\
