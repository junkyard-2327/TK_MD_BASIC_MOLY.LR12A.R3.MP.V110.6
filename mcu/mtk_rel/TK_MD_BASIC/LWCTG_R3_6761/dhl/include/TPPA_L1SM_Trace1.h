...
#include "L1Trc.h"
	...
	#define TPPA_L1SM_TMR_STA(v1, v2) do {\
		{\
			TRC_START_FILTER_CHECK_L1_NON_SMP(TPPA_L1SM_1_Trace_Filter, 1, 0x04);\
			...
			TRC_OUTPUT_16_FIRST_WRAPPER_L1_NON_SMP(0x0085,0x0085);\
			...
			TRC_END_FILTER_CHECK_L1_NON_SMP(TPPA_L1SM_1_Trace_Filter, 1, 0x04);\
		}\
	} while(0)
#else
...
/*******************************/
EXTERN_TMD_FILTER(unsigned char, TPPA_L1SM_1_Trace_Filter, 5);
/*************************/
...
#define ChkL1ModFltr_TPPA_L1SM_1()	(FILTER_CHECK(TPPA_L1SM_1_Trace_Filter, 0, 1))
#define ChkL1ClsFltr_TPPA_L1SM_1_TPPA_L1SM_H()	(ChkL1ModFltr_TPPA_L1SM_1()&&(FILTER_CHECK(TPPA_L1SM_1_Trace_Filter, 1, 0x01)))
#define ChkL1ClsFltr_TPPA_L1SM_1_TPPA_L1SM_M()	(ChkL1ModFltr_TPPA_L1SM_1()&&(FILTER_CHECK(TPPA_L1SM_1_Trace_Filter, 1, 0x02)))
#define ChkL1ClsFltr_TPPA_L1SM_1_TPPA_L1SM_L()	(ChkL1ModFltr_TPPA_L1SM_1()&&(FILTER_CHECK(TPPA_L1SM_1_Trace_Filter, 1, 0x04)))
