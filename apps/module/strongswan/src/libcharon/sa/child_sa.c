...
struct private_child_sa_t {
	...
	/**
	 * my traffic selectors for rekey
	 */
	linked_list_t *rekey_my_ts;

	/**
	 * other traffic selectors for rekey
	 */
	linked_list_t *rekey_other_ts;
};
...
METHOD(child_sa_t, set_rekey_my_ts, void,
	   private_child_sa_t *this, linked_list_t *rekey_my_ts)
{
	DBG1(DBG_IKE, "set_rekey_my_ts");
	if (this->rekey_my_ts)
	{
		this->rekey_my_ts->destroy_offset(this->rekey_my_ts, offsetof(traffic_selector_t, destroy));
	}
	this->rekey_my_ts = rekey_my_ts;
}

METHOD(child_sa_t, set_rekey_other_ts, void,
	   private_child_sa_t *this, linked_list_t *rekey_other_ts)
{
	DBG1(DBG_IKE, "set_rekey_other_ts");
	if (this->rekey_other_ts)
	{
		this->rekey_other_ts->destroy_offset(this->rekey_other_ts, offsetof(traffic_selector_t, destroy));
	}
	this->rekey_other_ts = rekey_other_ts;
}

METHOD(child_sa_t, get_rekey_my_ts, linked_list_t *,
	   private_child_sa_t *this)
{
	DBG1(DBG_IKE, "get_rekey_my_ts");
	return this->rekey_my_ts;
}

METHOD(child_sa_t, get_rekey_other_ts, linked_list_t *,
	   private_child_sa_t *this)
{
	DBG1(DBG_IKE, "get_rekey_other_ts");
	return this->rekey_other_ts;
}
							 ...
							 child_cfg_t *config, u_int32_t rekey, bool encap)
{
	...
	INIT(this,
		.public = {
			...
			.set_rekey_my_ts = _set_rekey_my_ts,
			.set_rekey_other_ts = _set_rekey_other_ts,
			.get_rekey_my_ts = _get_rekey_my_ts,
			.get_rekey_other_ts = _get_rekey_other_ts,
