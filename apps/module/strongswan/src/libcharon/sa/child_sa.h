...
struct child_sa_t {
	...
	/**
	 * Set my ts for this CHILD_SA rekey.
	 *
	 * @param my ts list
	 */
	void (*set_rekey_my_ts)(child_sa_t *this, linked_list_t * rekey_my_ts);

	/**
	 * Set other ts for this CHILD_SA rekey.
	 *
	 * @param other ts list
	 */
	void (*set_rekey_other_ts)(child_sa_t *this, linked_list_t * rekey_other_ts);

	/**
	 * get my ts for this CHILD_SA rekey.
	 *
	 * @Return my ts list
	 */
	linked_list_t * (*get_rekey_my_ts)(child_sa_t *this);

	/**
	 * get other ts for this CHILD_SA rekey.
	 *
	 * @Return other ts list
	 */
	linked_list_t * (*get_rekey_other_ts)(child_sa_t *this);
