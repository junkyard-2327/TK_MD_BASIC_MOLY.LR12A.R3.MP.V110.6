...
struct child_cfg_t {
	 ...
	 * Set wod configs
	 */
	void (*set_wod_options) (child_cfg_t *this, char *vif,
							bool force_tsi_64, bool force_tsi_full);

	/**
	 * Get virtual interface.
	 */
	char* (*get_vif) (child_cfg_t *this);

	/**
	 * Check whether TSi prefix should be replaced with internal IPv6 prefix.
	 */
	bool (*use_force_tsi_64)(child_cfg_t *this);

	/**
	 * Check whether TSi should be replaced with whole IP adress.
	 */
	bool (*use_force_tsi_full)(child_cfg_t *this);
};
