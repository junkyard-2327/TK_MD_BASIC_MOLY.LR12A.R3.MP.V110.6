...
struct ike_cfg_t {
	...
	/**
	 * Get the port to use as our source natt port.
	 *
	 * @return				source natt port, host order
	 */
	u_int16_t (*get_my_natt_port)(ike_cfg_t *this);

	/**
	 * Get the port to use as destination natt port.
	 *
	 * @return				destination natt address, host order
	 */
	u_int16_t (*get_other_natt_port)(ike_cfg_t *this);
	 ...
	 * Set wod configs
	 */
	void (*set_wod_options) (ike_cfg_t *this, u_int16_t my_natt_port,
