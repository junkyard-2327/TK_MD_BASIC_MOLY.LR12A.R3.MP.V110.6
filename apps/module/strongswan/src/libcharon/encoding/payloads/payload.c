...
ENUM_NEXT(payload_type_names, NAT_D_V1, NAT_OA_V1, CONFIGURATION_V1,
	"NAT_D_V1",
	"NAT_OA_V1");
ENUM_NEXT(payload_type_names, SECURITY_ASSOCIATION, PLV2_FRAGMENT, NAT_OA_V1,
	...
	"ENCRYPTED_FRAGMENT");
#ifdef ME
ENUM_NEXT(payload_type_names, ID_PEER, ID_PEER, PLV2_FRAGMENT,
	"ID_PEER");
ENUM_NEXT(payload_type_names, NAT_D_DRAFT_00_03_V1, FRAGMENT_V1, ID_PEER,
	...
	"FRAGMENT");
#else
ENUM_NEXT(payload_type_names, NAT_D_DRAFT_00_03_V1, FRAGMENT_V1, PLV2_FRAGMENT,
	"NAT_D_DRAFT_V1",
	"NAT_OA_DRAFT_V1",
	"FRAGMENT");
#endif /* ME */
...
ENUM_NEXT(payload_type_short_names, NAT_D_V1, NAT_OA_V1, CONFIGURATION_V1,
	"NAT-D",
	"NAT-OA");
ENUM_NEXT(payload_type_short_names, SECURITY_ASSOCIATION, PLV2_FRAGMENT, NAT_OA_V1,
	"SA",
	"KE",
	"IDi",
	"IDr",
	...
	"EF");
#ifdef ME
ENUM_NEXT(payload_type_short_names, ID_PEER, ID_PEER, PLV2_FRAGMENT,
	"IDp");
ENUM_NEXT(payload_type_short_names, NAT_D_DRAFT_00_03_V1, FRAGMENT_V1, ID_PEER,
	...
	"FRAG");
#else
ENUM_NEXT(payload_type_short_names, NAT_D_DRAFT_00_03_V1, FRAGMENT_V1, PLV2_FRAGMENT,
	"NAT-D",
	"NAT-OA",
	"FRAG");
#endif /* ME */
