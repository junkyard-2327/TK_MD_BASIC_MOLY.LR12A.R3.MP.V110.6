...
enum job_priority_t {
	...
	JOB_PRIO_CRITICAL = 0,
	/** Timing sensitibe job which needs to hold wake lock */
	JOB_PRIO_HIGH_WAKE_LOCK,
...
/**
 * The scope for acquire wake lock for alarm timer
 */
enum alarm_timer_wake_lock_t {
	ALARM_TIMER_WAKE_LOCK_NONE = 0,
	ALARM_TIMER_WAKE_LOCK_PARTIAL = 1,
	ALARM_TIMER_WAKE_LOCK_ALL = 2,
};
/**
...
#define JOB_WAKE_LOCK_ID            "strongSwan"
...
struct job_t {
	...
	/**
	 * Status of this job, is this job enqueue to scheduler and start the alarm timer
	 */
	bool is_start_alarm_timer;
