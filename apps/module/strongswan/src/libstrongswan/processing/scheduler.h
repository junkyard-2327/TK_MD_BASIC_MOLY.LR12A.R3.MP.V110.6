...
struct scheduler_t {
	...
	/**
	 * Returns the result of wake lock release.
	 *
	 * @return				the result of wake lock release
	 */
	bool (*release_alarm_timer_wake_lock) (scheduler_t *this, job_priority_t job_priority, bool is_force_release);
