...
ENUM_BEGIN(configuration_attribute_type_names, INTERNAL_IP4_ADDRESS, P_CSCF_IP6_ADDRESS,
	...
	"P_CSCF_IP4_ADDRESS",
	"P_CSCF_IP6_ADDRESS");
ENUM_NEXT(configuration_attribute_type_names, TIMEOUT_PERIOD_FOR_LIVENESS_CHECK, TIMEOUT_PERIOD_FOR_LIVENESS_CHECK, P_CSCF_IP6_ADDRESS,
...
ENUM_BEGIN(configuration_attribute_type_short_names, INTERNAL_IP4_ADDRESS,  P_CSCF_IP6_ADDRESS,
	...
	"PCSCF",
	"PCSCF6");
ENUM_NEXT(configuration_attribute_type_short_names, TIMEOUT_PERIOD_FOR_LIVENESS_CHECK, TIMEOUT_PERIOD_FOR_LIVENESS_CHECK, P_CSCF_IP6_ADDRESS,
	"LIVENESS_CHECK");
